...
task test, "Run cpu tests":
  ...
  exec """nim cpp --define:useRealtimeGC -r -o:test torch/nn.nim"""
  exec """nim cpp --define:useRealtimeGC -d:release -r -o:test torch/nn.nim"""
...
task test_clang, "Run clang tests":
  ...
  exec """nim cpp --define:useRealtimeGC --cc:clang -r -o:test torch/nn.nim"""
  exec """nim cpp --define:useRealtimeGC -d:release --cc:clang -r -o:test torch/nn.nim"""
