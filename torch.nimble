...
task test, "Run cpu tests":
  ...
  exec """nim cpp --define:useRealtimeGC -r -o:test torch/nn/nn.nim"""
  exec """nim cpp --define:useRealtimeGC -d:release -r -o:test torch/nn/nn.nim"""
...
task test_wasm, "Run wasm tests":
  ...
  exec """nim cpp -d:release -d:wasm -o:test.js torch/nn/nn.nim && node test.js"""
...
task test_cuda, "Run cuda gpu tests":
  ...
  exec """nim cpp -r -o:test -d:cuda torch/nn/nn.nim"""
  exec """nim cpp -d:release -r -o:test -d:cuda torch/nn/nn.nim"""
...
task test_clang, "Run clang tests":
  ...
  exec """nim cpp --define:useRealtimeGC --cc:clang -r -o:test torch/nn/nn.nim"""
  exec """nim cpp --define:useRealtimeGC -d:release --cc:clang -r -o:test torch/nn/nn.nim"""
...
task test_clang_cuda, "Run clang cuda gpu tests":
  ...
  exec """nim cpp --cc:clang -r -o:test -d:cuda torch/nn/nn.nim"""
  exec """nim cpp -d:release --cc:clang -r -o:test -d:cuda torch/nn/nn.nim"""
