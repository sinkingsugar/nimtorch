...
proc th_set_impl_inplace*(self: Tensor; source: AStorage): Tensor {.inline, discardable.} = 
  check: atenFunction("at::_th_set_", self.tensor, source).to(void); self
...
proc th_set_impl_inplace*(self: Tensor; source: AStorage; storage_offset: int; size: openarray[int]; stride: openarray[int]): Tensor {.inline, discardable.} = 
  check: atenFunction("at::_th_set_", self.tensor, source, storage_offset, size.toAIntList(), stride.toAIntList()).to(void); self
...
proc th_set_impl_inplace*(self: Tensor; source: Tensor): Tensor {.inline, discardable.} = 
  check: atenFunction("at::_th_set_", self.tensor, source.tensor).to(void); self
...
proc th_set_impl_inplace*(self: Tensor): Tensor {.inline, discardable.} = 
  check: atenFunction("at::_th_set_", self.tensor).to(void); self
...
proc th_is_set_to_impl*(self: Tensor; tensor: Tensor): bool {.inline.} = 
  check: atenFunction("at::_th_is_set_to", self.tensor, tensor.tensor).to(bool)
...
proc th_masked_fill_impl_inplace*(self: Tensor; mask: Tensor; value: float): Tensor {.inline, discardable.} = 
  check: atenFunction("at::_th_masked_fill_", self.tensor, mask.tensor, value).to(void); self
...
proc th_masked_fill_impl_inplace*(self: Tensor; mask: Tensor; value: Tensor): Tensor {.inline, discardable.} = 
  check: atenFunction("at::_th_masked_fill_", self.tensor, mask.tensor, value.tensor).to(void); self
...
proc th_masked_scatter_impl_inplace*(self: Tensor; mask: Tensor; source: Tensor): Tensor {.inline, discardable.} = 
  check: atenFunction("at::_th_masked_scatter_", self.tensor, mask.tensor, source.tensor).to(void); self
...
proc th_masked_select_impl*(self: Tensor; mask: Tensor): Tensor {.inline.} = 
  check: atenFunction("at::_th_masked_select", self.tensor, mask.tensor).to(ATensor).newTensor()
...
proc th_nonzero_impl*(self: Tensor): Tensor {.inline.} = 
  check: atenFunction("at::_th_nonzero", self.tensor).to(ATensor).newTensor()
...
proc th_view_impl*(self: Tensor; size: openarray[int]): Tensor {.inline.} = 
  check: atenFunction("at::_th_view", self.tensor, size.toAIntList()).to(ATensor).newTensor()
...
proc th_index_select_impl*(self: Tensor; dim: int; index: Tensor): Tensor {.inline.} = 
  check: atenFunction("at::_th_index_select", self.tensor, dim, index.tensor).to(ATensor).newTensor()
...
proc th_take_impl*(self: Tensor; index: Tensor): Tensor {.inline.} = 
  check: atenFunction("at::_th_take", self.tensor, index.tensor).to(ATensor).newTensor()
...
proc th_put_impl_inplace*(self: Tensor; index: Tensor; source: Tensor; accumulate: bool = false): Tensor {.inline, discardable.} = 
  check: atenFunction("at::_th_put_", self.tensor, index.tensor, source.tensor, accumulate).to(void); self
...
proc th_index_add_impl_inplace*(self: Tensor; dim: int; index: Tensor; source: Tensor): Tensor {.inline, discardable.} = 
  check: atenFunction("at::_th_index_add_", self.tensor, dim, index.tensor, source.tensor).to(void); self
...
proc th_index_fill_impl_inplace*(self: Tensor; dim: int; index: Tensor; value: float): Tensor {.inline, discardable.} = 
  check: atenFunction("at::_th_index_fill_", self.tensor, dim, index.tensor, value).to(void); self
...
proc th_index_fill_impl_inplace*(self: Tensor; dim: int; index: Tensor; value: Tensor): Tensor {.inline, discardable.} = 
  check: atenFunction("at::_th_index_fill_", self.tensor, dim, index.tensor, value.tensor).to(void); self

proc th_unfold_impl*(ty: TensorType; self: Tensor; dimension: int; size: int; step: int): Tensor {.inline.} = 
  check: ty[].atenMethod("_th_unfold", self.tensor, dimension, size, step).to(ATensor).newTensor()

proc th_unfold_impl*(self: Tensor; dimension: int; size: int; step: int): Tensor {.inline.} = 
  check: atenFunction("at::_th_unfold", self.tensor, dimension, size, step).to(ATensor).newTensor()
...
proc th_scatter_impl_inplace*(self: Tensor; dim: int; index: Tensor; src: Tensor): Tensor {.inline, discardable.} = 
  check: atenFunction("at::_th_scatter_", self.tensor, dim, index.tensor, src.tensor).to(void); self
...
proc th_scatter_impl_inplace*(self: Tensor; dim: int; index: Tensor; value: float): Tensor {.inline, discardable.} = 
  check: atenFunction("at::_th_scatter_", self.tensor, dim, index.tensor, value).to(void); self
...
proc th_scatter_add_impl_inplace*(self: Tensor; dim: int; index: Tensor; src: Tensor): Tensor {.inline, discardable.} = 
  check: atenFunction("at::_th_scatter_add_", self.tensor, dim, index.tensor, src.tensor).to(void); self
...
proc th_gather_impl*(self: Tensor; dim: int; index: Tensor): Tensor {.inline.} = 
  check: atenFunction("at::_th_gather", self.tensor, dim, index.tensor).to(ATensor).newTensor()
...
proc th_equal_impl*(self: Tensor; other: Tensor): bool {.inline.} = 
  check: atenFunction("at::_th_equal", self.tensor, other.tensor).to(bool)
...
proc th_and_impl*(self: Tensor; other: float): Tensor {.inline.} = 
  check: atenFunction("at::_th_and", self.tensor, other).to(ATensor).newTensor()
...
proc th_and_impl*(self: Tensor; other: Tensor): Tensor {.inline.} = 
  check: atenFunction("at::_th_and", self.tensor, other.tensor).to(ATensor).newTensor()
...
proc th_iand_impl_inplace*(self: Tensor; other: float): Tensor {.inline, discardable.} = 
  check: atenFunction("at::_th_iand_", self.tensor, other).to(void); self
...
proc th_iand_impl_inplace*(self: Tensor; other: Tensor): Tensor {.inline, discardable.} = 
  check: atenFunction("at::_th_iand_", self.tensor, other.tensor).to(void); self
...
proc th_or_impl*(self: Tensor; other: float): Tensor {.inline.} = 
  check: atenFunction("at::_th_or", self.tensor, other).to(ATensor).newTensor()
...
proc th_or_impl*(self: Tensor; other: Tensor): Tensor {.inline.} = 
  check: atenFunction("at::_th_or", self.tensor, other.tensor).to(ATensor).newTensor()
...
proc th_ior_impl_inplace*(self: Tensor; other: float): Tensor {.inline, discardable.} = 
  check: atenFunction("at::_th_ior_", self.tensor, other).to(void); self
...
proc th_ior_impl_inplace*(self: Tensor; other: Tensor): Tensor {.inline, discardable.} = 
  check: atenFunction("at::_th_ior_", self.tensor, other.tensor).to(void); self
...
proc th_xor_impl*(self: Tensor; other: float): Tensor {.inline.} = 
  check: atenFunction("at::_th_xor", self.tensor, other).to(ATensor).newTensor()
...
proc th_xor_impl*(self: Tensor; other: Tensor): Tensor {.inline.} = 
  check: atenFunction("at::_th_xor", self.tensor, other.tensor).to(ATensor).newTensor()
...
proc th_ixor_impl_inplace*(self: Tensor; other: float): Tensor {.inline, discardable.} = 
  check: atenFunction("at::_th_ixor_", self.tensor, other).to(void); self
...
proc th_ixor_impl_inplace*(self: Tensor; other: Tensor): Tensor {.inline, discardable.} = 
  check: atenFunction("at::_th_ixor_", self.tensor, other.tensor).to(void); self
...
proc th_lshift_impl*(self: Tensor; other: float): Tensor {.inline.} = 
  check: atenFunction("at::_th_lshift", self.tensor, other).to(ATensor).newTensor()
...
proc th_lshift_impl*(self: Tensor; other: Tensor): Tensor {.inline.} = 
  check: atenFunction("at::_th_lshift", self.tensor, other.tensor).to(ATensor).newTensor()
...
proc th_ilshift_impl_inplace*(self: Tensor; other: float): Tensor {.inline, discardable.} = 
  check: atenFunction("at::_th_ilshift_", self.tensor, other).to(void); self
...
proc th_ilshift_impl_inplace*(self: Tensor; other: Tensor): Tensor {.inline, discardable.} = 
  check: atenFunction("at::_th_ilshift_", self.tensor, other.tensor).to(void); self
...
proc th_rshift_impl*(self: Tensor; other: float): Tensor {.inline.} = 
  check: atenFunction("at::_th_rshift", self.tensor, other).to(ATensor).newTensor()
...
proc th_rshift_impl*(self: Tensor; other: Tensor): Tensor {.inline.} = 
  check: atenFunction("at::_th_rshift", self.tensor, other.tensor).to(ATensor).newTensor()
...
proc th_irshift_impl_inplace*(self: Tensor; other: float): Tensor {.inline, discardable.} = 
  check: atenFunction("at::_th_irshift_", self.tensor, other).to(void); self
...
proc th_irshift_impl_inplace*(self: Tensor; other: Tensor): Tensor {.inline, discardable.} = 
  check: atenFunction("at::_th_irshift_", self.tensor, other.tensor).to(void); self
...
proc th_lt_impl*(self: Tensor; other: float): Tensor {.inline.} = 
  check: atenFunction("at::_th_lt", self.tensor, other).to(ATensor).newTensor()
...
proc th_lt_impl*(self: Tensor; other: Tensor): Tensor {.inline.} = 
  check: atenFunction("at::_th_lt", self.tensor, other.tensor).to(ATensor).newTensor()
...
proc th_lt_impl_inplace*(self: Tensor; other: float): Tensor {.inline, discardable.} = 
  check: atenFunction("at::_th_lt_", self.tensor, other).to(void); self
...
proc th_lt_impl_inplace*(self: Tensor; other: Tensor): Tensor {.inline, discardable.} = 
  check: atenFunction("at::_th_lt_", self.tensor, other.tensor).to(void); self
...
proc th_gt_impl*(self: Tensor; other: float): Tensor {.inline.} = 
  check: atenFunction("at::_th_gt", self.tensor, other).to(ATensor).newTensor()
...
proc th_gt_impl*(self: Tensor; other: Tensor): Tensor {.inline.} = 
  check: atenFunction("at::_th_gt", self.tensor, other.tensor).to(ATensor).newTensor()
...
proc th_gt_impl_inplace*(self: Tensor; other: float): Tensor {.inline, discardable.} = 
  check: atenFunction("at::_th_gt_", self.tensor, other).to(void); self
...
proc th_gt_impl_inplace*(self: Tensor; other: Tensor): Tensor {.inline, discardable.} = 
  check: atenFunction("at::_th_gt_", self.tensor, other.tensor).to(void); self
...
proc th_le_impl*(self: Tensor; other: float): Tensor {.inline.} = 
  check: atenFunction("at::_th_le", self.tensor, other).to(ATensor).newTensor()
...
proc th_le_impl*(self: Tensor; other: Tensor): Tensor {.inline.} = 
  check: atenFunction("at::_th_le", self.tensor, other.tensor).to(ATensor).newTensor()
...
proc th_le_impl_inplace*(self: Tensor; other: float): Tensor {.inline, discardable.} = 
  check: atenFunction("at::_th_le_", self.tensor, other).to(void); self
...
proc th_le_impl_inplace*(self: Tensor; other: Tensor): Tensor {.inline, discardable.} = 
  check: atenFunction("at::_th_le_", self.tensor, other.tensor).to(void); self
...
proc th_ge_impl*(self: Tensor; other: float): Tensor {.inline.} = 
  check: atenFunction("at::_th_ge", self.tensor, other).to(ATensor).newTensor()
...
proc th_ge_impl*(self: Tensor; other: Tensor): Tensor {.inline.} = 
  check: atenFunction("at::_th_ge", self.tensor, other.tensor).to(ATensor).newTensor()
...
proc th_ge_impl_inplace*(self: Tensor; other: float): Tensor {.inline, discardable.} = 
  check: atenFunction("at::_th_ge_", self.tensor, other).to(void); self
...
proc th_ge_impl_inplace*(self: Tensor; other: Tensor): Tensor {.inline, discardable.} = 
  check: atenFunction("at::_th_ge_", self.tensor, other.tensor).to(void); self
...
proc th_eq_impl*(self: Tensor; other: float): Tensor {.inline.} = 
  check: atenFunction("at::_th_eq", self.tensor, other).to(ATensor).newTensor()
...
proc th_eq_impl*(self: Tensor; other: Tensor): Tensor {.inline.} = 
  check: atenFunction("at::_th_eq", self.tensor, other.tensor).to(ATensor).newTensor()
...
proc th_eq_impl_inplace*(self: Tensor; other: float): Tensor {.inline, discardable.} = 
  check: atenFunction("at::_th_eq_", self.tensor, other).to(void); self
...
proc th_eq_impl_inplace*(self: Tensor; other: Tensor): Tensor {.inline, discardable.} = 
  check: atenFunction("at::_th_eq_", self.tensor, other.tensor).to(void); self
...
proc th_ne_impl*(self: Tensor; other: float): Tensor {.inline.} = 
  check: atenFunction("at::_th_ne", self.tensor, other).to(ATensor).newTensor()
...
proc th_ne_impl*(self: Tensor; other: Tensor): Tensor {.inline.} = 
  check: atenFunction("at::_th_ne", self.tensor, other.tensor).to(ATensor).newTensor()
...
proc th_ne_impl_inplace*(self: Tensor; other: float): Tensor {.inline, discardable.} = 
  check: atenFunction("at::_th_ne_", self.tensor, other).to(void); self
...
proc th_ne_impl_inplace*(self: Tensor; other: Tensor): Tensor {.inline, discardable.} = 
  check: atenFunction("at::_th_ne_", self.tensor, other.tensor).to(void); self

proc th_min_impl*(ty: TensorType; self: Tensor; other: Tensor): Tensor {.inline.} = 
  check: ty[].atenMethod("_th_min", self.tensor, other.tensor).to(ATensor).newTensor()

proc th_min_impl*(self: Tensor; other: Tensor): Tensor {.inline.} = 
  check: atenFunction("at::_th_min", self.tensor, other.tensor).to(ATensor).newTensor()

proc th_min_impl*(ty: TensorType; self: Tensor): float {.inline.} = 
  check: ty[].atenMethod("_th_min", self.tensor).to(float)

proc th_min_impl*(self: Tensor): float {.inline.} = 
  check: atenFunction("at::_th_min", self.tensor).to(float)
...
proc th_max_impl*(ty: TensorType; self: Tensor; other: Tensor): Tensor {.inline.} = 
  check: ty[].atenMethod("_th_max", self.tensor, other.tensor).to(ATensor).newTensor()

proc th_max_impl*(self: Tensor; other: Tensor): Tensor {.inline.} = 
  check: atenFunction("at::_th_max", self.tensor, other.tensor).to(ATensor).newTensor()

proc th_max_impl*(ty: TensorType; self: Tensor): float {.inline.} = 
  check: ty[].atenMethod("_th_max", self.tensor).to(float)

proc th_max_impl*(self: Tensor): float {.inline.} = 
  check: atenFunction("at::_th_max", self.tensor).to(float)
...
proc th_median_impl*(ty: TensorType; self: Tensor): float {.inline.} = 
  check: ty[].atenMethod("_th_median", self.tensor).to(float)

proc th_median_impl*(self: Tensor): float {.inline.} = 
  check: atenFunction("at::_th_median", self.tensor).to(float)
...
proc th_sort_impl*(ty: TensorType; self: Tensor; dim: int = -1; descending: bool = false): tuple[values: Tensor, indices: Tensor] {.inline.} = 
  check: ty[].atenMethod("_th_sort", self.tensor, dim, descending).to(StdTuple2[ATensor, ATensor]).toNimTuple().newTensors()

proc th_sort_impl*(self: Tensor; dim: int = -1; descending: bool = false): tuple[values: Tensor, indices: Tensor] {.inline.} = 
  check: atenFunction("at::_th_sort", self.tensor, dim, descending).to(StdTuple2[ATensor, ATensor]).toNimTuple().newTensors()
...
proc th_topk_impl*(ty: TensorType; self: Tensor; k: int; dim: int = -1; largest: bool = true; sorted: bool = true): tuple[values: Tensor, indices: Tensor] {.inline.} = 
  check: ty[].atenMethod("_th_topk", self.tensor, k, dim, largest, sorted).to(StdTuple2[ATensor, ATensor]).toNimTuple().newTensors()
...
proc th_topk_impl*(self: Tensor; k: int; dim: int = -1; largest: bool = true; sorted: bool = true): tuple[values: Tensor, indices: Tensor] {.inline.} = 
  check: atenFunction("at::_th_topk", self.tensor, k, dim, largest, sorted).to(StdTuple2[ATensor, ATensor]).toNimTuple().newTensors()

proc th_all_impl*(ty: TensorType; self: Tensor): float {.inline.} = 
  check: ty[].atenMethod("_th_all", self.tensor).to(float)

proc th_all_impl*(self: Tensor): float {.inline.} = 
  check: atenFunction("at::_th_all", self.tensor).to(float)
...
proc th_any_impl*(ty: TensorType; self: Tensor): float {.inline.} = 
  check: ty[].atenMethod("_th_any", self.tensor).to(float)

proc th_any_impl*(self: Tensor): float {.inline.} = 
  check: atenFunction("at::_th_any", self.tensor).to(float)
...
proc th_abs_impl*(ty: TensorType; self: Tensor): Tensor {.inline.} = 
  check: ty[].atenMethod("_th_abs", self.tensor).to(ATensor).newTensor()

proc th_abs_impl*(self: Tensor): Tensor {.inline.} = 
  check: atenFunction("at::_th_abs", self.tensor).to(ATensor).newTensor()
...
proc th_log_impl*(ty: TensorType; self: Tensor): Tensor {.inline.} = 
  check: ty[].atenMethod("_th_log", self.tensor).to(ATensor).newTensor()

proc th_log_impl*(self: Tensor): Tensor {.inline.} = 
  check: atenFunction("at::_th_log", self.tensor).to(ATensor).newTensor()

proc th_log10_impl*(ty: TensorType; self: Tensor): Tensor {.inline.} = 
  check: ty[].atenMethod("_th_log10", self.tensor).to(ATensor).newTensor()

proc th_log10_impl*(self: Tensor): Tensor {.inline.} = 
  check: atenFunction("at::_th_log10", self.tensor).to(ATensor).newTensor()

proc th_log1p_impl*(ty: TensorType; self: Tensor): Tensor {.inline.} = 
  check: ty[].atenMethod("_th_log1p", self.tensor).to(ATensor).newTensor()

proc th_log1p_impl*(self: Tensor): Tensor {.inline.} = 
  check: atenFunction("at::_th_log1p", self.tensor).to(ATensor).newTensor()

proc th_log2_impl*(ty: TensorType; self: Tensor): Tensor {.inline.} = 
  check: ty[].atenMethod("_th_log2", self.tensor).to(ATensor).newTensor()

proc th_log2_impl*(self: Tensor): Tensor {.inline.} = 
  check: atenFunction("at::_th_log2", self.tensor).to(ATensor).newTensor()
...
proc th_lgamma_impl*(self: Tensor): Tensor {.inline.} = 
  check: atenFunction("at::_th_lgamma", self.tensor).to(ATensor).newTensor()
...
proc th_lgamma_impl_inplace*(self: Tensor): Tensor {.inline, discardable.} = 
  check: atenFunction("at::_th_lgamma_", self.tensor).to(void); self
...
proc th_digamma_impl*(self: Tensor): Tensor {.inline.} = 
  check: atenFunction("at::_th_digamma", self.tensor).to(ATensor).newTensor()
...
proc th_digamma_impl_inplace*(self: Tensor): Tensor {.inline, discardable.} = 
  check: atenFunction("at::_th_digamma_", self.tensor).to(void); self
...
proc th_polygamma_impl*(n: int; self: Tensor): Tensor {.inline.} = 
  check: atenFunction("at::_th_polygamma", n, self.tensor).to(ATensor).newTensor()
...
proc th_polygamma_impl_inplace*(self: Tensor; n: int): Tensor {.inline, discardable.} = 
  check: atenFunction("at::_th_polygamma_", self.tensor, n).to(void); self

proc th_exp_impl*(ty: TensorType; self: Tensor): Tensor {.inline.} = 
  check: ty[].atenMethod("_th_exp", self.tensor).to(ATensor).newTensor()

proc th_exp_impl*(self: Tensor): Tensor {.inline.} = 
  check: atenFunction("at::_th_exp", self.tensor).to(ATensor).newTensor()

proc th_expm1_impl*(ty: TensorType; self: Tensor): Tensor {.inline.} = 
  check: ty[].atenMethod("_th_expm1", self.tensor).to(ATensor).newTensor()

proc th_expm1_impl*(self: Tensor): Tensor {.inline.} = 
  check: atenFunction("at::_th_expm1", self.tensor).to(ATensor).newTensor()

proc th_cos_impl*(ty: TensorType; self: Tensor): Tensor {.inline.} = 
  check: ty[].atenMethod("_th_cos", self.tensor).to(ATensor).newTensor()

proc th_cos_impl*(self: Tensor): Tensor {.inline.} = 
  check: atenFunction("at::_th_cos", self.tensor).to(ATensor).newTensor()

proc th_acos_impl*(ty: TensorType; self: Tensor): Tensor {.inline.} = 
  check: ty[].atenMethod("_th_acos", self.tensor).to(ATensor).newTensor()

proc th_acos_impl*(self: Tensor): Tensor {.inline.} = 
  check: atenFunction("at::_th_acos", self.tensor).to(ATensor).newTensor()

proc th_cosh_impl*(ty: TensorType; self: Tensor): Tensor {.inline.} = 
  check: ty[].atenMethod("_th_cosh", self.tensor).to(ATensor).newTensor()

proc th_cosh_impl*(self: Tensor): Tensor {.inline.} = 
  check: atenFunction("at::_th_cosh", self.tensor).to(ATensor).newTensor()

proc th_sin_impl*(ty: TensorType; self: Tensor): Tensor {.inline.} = 
  check: ty[].atenMethod("_th_sin", self.tensor).to(ATensor).newTensor()

proc th_sin_impl*(self: Tensor): Tensor {.inline.} = 
  check: atenFunction("at::_th_sin", self.tensor).to(ATensor).newTensor()

proc th_asin_impl*(ty: TensorType; self: Tensor): Tensor {.inline.} = 
  check: ty[].atenMethod("_th_asin", self.tensor).to(ATensor).newTensor()

proc th_asin_impl*(self: Tensor): Tensor {.inline.} = 
  check: atenFunction("at::_th_asin", self.tensor).to(ATensor).newTensor()

proc th_sinh_impl*(ty: TensorType; self: Tensor): Tensor {.inline.} = 
  check: ty[].atenMethod("_th_sinh", self.tensor).to(ATensor).newTensor()

proc th_sinh_impl*(self: Tensor): Tensor {.inline.} = 
  check: atenFunction("at::_th_sinh", self.tensor).to(ATensor).newTensor()

proc th_tan_impl*(ty: TensorType; self: Tensor): Tensor {.inline.} = 
  check: ty[].atenMethod("_th_tan", self.tensor).to(ATensor).newTensor()

proc th_tan_impl*(self: Tensor): Tensor {.inline.} = 
  check: atenFunction("at::_th_tan", self.tensor).to(ATensor).newTensor()

proc th_atan_impl*(ty: TensorType; self: Tensor): Tensor {.inline.} = 
  check: ty[].atenMethod("_th_atan", self.tensor).to(ATensor).newTensor()

proc th_atan_impl*(self: Tensor): Tensor {.inline.} = 
  check: atenFunction("at::_th_atan", self.tensor).to(ATensor).newTensor()
...
proc th_erf_impl*(ty: TensorType; self: Tensor): Tensor {.inline.} = 
  check: ty[].atenMethod("_th_erf", self.tensor).to(ATensor).newTensor()

proc th_erf_impl*(self: Tensor): Tensor {.inline.} = 
  check: atenFunction("at::_th_erf", self.tensor).to(ATensor).newTensor()

proc th_erfc_impl*(ty: TensorType; self: Tensor): Tensor {.inline.} = 
  check: ty[].atenMethod("_th_erfc", self.tensor).to(ATensor).newTensor()

proc th_erfc_impl*(self: Tensor): Tensor {.inline.} = 
  check: atenFunction("at::_th_erfc", self.tensor).to(ATensor).newTensor()
...
proc th_erfinv_impl_inplace*(self: Tensor): Tensor {.inline, discardable.} = 
  check: atenFunction("at::_th_erfinv_", self.tensor).to(void); self
...
proc th_erfinv_impl*(self: Tensor): Tensor {.inline.} = 
  check: atenFunction("at::_th_erfinv", self.tensor).to(ATensor).newTensor()

proc th_sqrt_impl*(ty: TensorType; self: Tensor): Tensor {.inline.} = 
  check: ty[].atenMethod("_th_sqrt", self.tensor).to(ATensor).newTensor()

proc th_sqrt_impl*(self: Tensor): Tensor {.inline.} = 
  check: atenFunction("at::_th_sqrt", self.tensor).to(ATensor).newTensor()

proc th_rsqrt_impl*(ty: TensorType; self: Tensor): Tensor {.inline.} = 
  check: ty[].atenMethod("_th_rsqrt", self.tensor).to(ATensor).newTensor()

proc th_rsqrt_impl*(self: Tensor): Tensor {.inline.} = 
  check: atenFunction("at::_th_rsqrt", self.tensor).to(ATensor).newTensor()

proc th_ceil_impl*(ty: TensorType; self: Tensor): Tensor {.inline.} = 
  check: ty[].atenMethod("_th_ceil", self.tensor).to(ATensor).newTensor()

proc th_ceil_impl*(self: Tensor): Tensor {.inline.} = 
  check: atenFunction("at::_th_ceil", self.tensor).to(ATensor).newTensor()

proc th_floor_impl*(ty: TensorType; self: Tensor): Tensor {.inline.} = 
  check: ty[].atenMethod("_th_floor", self.tensor).to(ATensor).newTensor()

proc th_floor_impl*(self: Tensor): Tensor {.inline.} = 
  check: atenFunction("at::_th_floor", self.tensor).to(ATensor).newTensor()

proc th_round_impl*(ty: TensorType; self: Tensor): Tensor {.inline.} = 
  check: ty[].atenMethod("_th_round", self.tensor).to(ATensor).newTensor()

proc th_round_impl*(self: Tensor): Tensor {.inline.} = 
  check: atenFunction("at::_th_round", self.tensor).to(ATensor).newTensor()

proc th_trunc_impl*(ty: TensorType; self: Tensor): Tensor {.inline.} = 
  check: ty[].atenMethod("_th_trunc", self.tensor).to(ATensor).newTensor()

proc th_trunc_impl*(self: Tensor): Tensor {.inline.} = 
  check: atenFunction("at::_th_trunc", self.tensor).to(ATensor).newTensor()
...
proc th_frac_impl_inplace*(self: Tensor): Tensor {.inline, discardable.} = 
  check: atenFunction("at::_th_frac_", self.tensor).to(void); self
...
proc th_frac_impl*(self: Tensor): Tensor {.inline.} = 
  check: atenFunction("at::_th_frac", self.tensor).to(ATensor).newTensor()
...
proc th_renorm_impl*(ty: TensorType; self: Tensor; p: float; dim: int; maxnorm: float): Tensor {.inline.} = 
  check: ty[].atenMethod("_th_renorm", self.tensor, p, dim, maxnorm).to(ATensor).newTensor()

proc th_renorm_impl*(self: Tensor; p: float; dim: int; maxnorm: float): Tensor {.inline.} = 
  check: atenFunction("at::_th_renorm", self.tensor, p, dim, maxnorm).to(ATensor).newTensor()
...
proc th_renorm_impl_inplace*(self: Tensor; p: float; dim: int; maxnorm: float): Tensor {.inline, discardable.} = 
  check: atenFunction("at::_th_renorm_", self.tensor, p, dim, maxnorm).to(void); self
...
proc th_dist_impl*(self: Tensor; other: Tensor; p: float = 2): float {.inline.} = 
  check: atenFunction("at::_th_dist", self.tensor, other.tensor, p).to(float)
...
proc th_reciprocal_impl*(self: Tensor): Tensor {.inline.} = 
  check: atenFunction("at::_th_reciprocal", self.tensor).to(ATensor).newTensor()
...
proc th_reciprocal_impl_inplace*(self: Tensor): Tensor {.inline, discardable.} = 
  check: atenFunction("at::_th_reciprocal_", self.tensor).to(void); self
...
proc th_neg_impl*(self: Tensor): Tensor {.inline.} = 
  check: atenFunction("at::_th_neg", self.tensor).to(ATensor).newTensor()
...
proc th_neg_impl_inplace*(self: Tensor): Tensor {.inline, discardable.} = 
  check: atenFunction("at::_th_neg_", self.tensor).to(void); self
...
proc th_atan2_impl*(self: Tensor; other: Tensor): Tensor {.inline.} = 
  check: atenFunction("at::_th_atan2", self.tensor, other.tensor).to(ATensor).newTensor()
...
proc th_atan2_impl_inplace*(self: Tensor; other: Tensor): Tensor {.inline, discardable.} = 
  check: atenFunction("at::_th_atan2_", self.tensor, other.tensor).to(void); self
...
proc th_pow_impl*(ty: TensorType; self: Tensor; exponent: Tensor): Tensor {.inline.} = 
  check: ty[].atenMethod("_th_pow", self.tensor, exponent.tensor).to(ATensor).newTensor()

proc th_pow_impl*(self: Tensor; exponent: Tensor): Tensor {.inline.} = 
  check: atenFunction("at::_th_pow", self.tensor, exponent.tensor).to(ATensor).newTensor()

proc th_pow_impl*(ty: TensorType; self: float; exponent: Tensor): Tensor {.inline.} = 
  check: ty[].atenMethod("_th_pow", self, exponent.tensor).to(ATensor).newTensor()

proc th_pow_impl*(self: float; exponent: Tensor): Tensor {.inline.} = 
  check: atenFunction("at::_th_pow", self, exponent.tensor).to(ATensor).newTensor()
...
proc th_pow_impl_inplace*(self: Tensor; exponent: float): Tensor {.inline, discardable.} = 
  check: atenFunction("at::_th_pow_", self.tensor, exponent).to(void); self
...
proc th_pow_impl_inplace*(self: Tensor; exponent: Tensor): Tensor {.inline, discardable.} = 
  check: atenFunction("at::_th_pow_", self.tensor, exponent.tensor).to(void); self

proc th_lerp_impl*(ty: TensorType; self: Tensor; end_special: Tensor; weight: float): Tensor {.inline.} = 
  check: ty[].atenMethod("_th_lerp", self.tensor, end_special.tensor, weight).to(ATensor).newTensor()

proc th_lerp_impl*(self: Tensor; end_special: Tensor; weight: float): Tensor {.inline.} = 
  check: atenFunction("at::_th_lerp", self.tensor, end_special.tensor, weight).to(ATensor).newTensor()

proc th_lerp_impl_inplace*(ty: TensorType; self: Tensor; end_special: Tensor; weight: float): Tensor {.inline, discardable.} = 
  check: ty[].atenMethod("_th_lerp_", self.tensor, end_special.tensor, weight).to(void); self

proc th_lerp_impl_inplace*(self: Tensor; end_special: Tensor; weight: float): Tensor {.inline, discardable.} = 
  check: atenFunction("at::_th_lerp_", self.tensor, end_special.tensor, weight).to(void); self
...
proc th_histc_impl*(self: Tensor; bins: int = 100; min: float = 0; max: float = 0): Tensor {.inline.} = 
  check: atenFunction("at::_th_histc", self.tensor, bins, min, max).to(ATensor).newTensor()
...
proc th_cumsum_impl*(ty: TensorType; self: Tensor; dim: int): Tensor {.inline.} = 
  check: ty[].atenMethod("_th_cumsum", self.tensor, dim).to(ATensor).newTensor()

proc th_cumsum_impl*(self: Tensor; dim: int): Tensor {.inline.} = 
  check: atenFunction("at::_th_cumsum", self.tensor, dim).to(ATensor).newTensor()

proc th_cumprod_impl*(ty: TensorType; self: Tensor; dim: int): Tensor {.inline.} = 
  check: ty[].atenMethod("_th_cumprod", self.tensor, dim).to(ATensor).newTensor()

proc th_cumprod_impl*(self: Tensor; dim: int): Tensor {.inline.} = 
  check: atenFunction("at::_th_cumprod", self.tensor, dim).to(ATensor).newTensor()
...
proc th_sign_impl*(self: Tensor): Tensor {.inline.} = 
  check: atenFunction("at::_th_sign", self.tensor).to(ATensor).newTensor()
...
proc th_sign_impl_inplace*(self: Tensor): Tensor {.inline, discardable.} = 
  check: atenFunction("at::_th_sign_", self.tensor).to(void); self
...
proc th_trace_impl*(self: Tensor): float {.inline.} = 
  check: atenFunction("at::_th_trace", self.tensor).to(float)
...
proc th_fmod_impl*(self: Tensor; other: float): Tensor {.inline.} = 
  check: atenFunction("at::_th_fmod", self.tensor, other).to(ATensor).newTensor()
...
proc th_fmod_impl*(self: Tensor; other: Tensor): Tensor {.inline.} = 
  check: atenFunction("at::_th_fmod", self.tensor, other.tensor).to(ATensor).newTensor()
...
proc th_fmod_impl_inplace*(self: Tensor; other: float): Tensor {.inline, discardable.} = 
  check: atenFunction("at::_th_fmod_", self.tensor, other).to(void); self
...
proc th_fmod_impl_inplace*(self: Tensor; other: Tensor): Tensor {.inline, discardable.} = 
  check: atenFunction("at::_th_fmod_", self.tensor, other.tensor).to(void); self
...
proc th_remainder_impl*(self: Tensor; other: float): Tensor {.inline.} = 
  check: atenFunction("at::_th_remainder", self.tensor, other).to(ATensor).newTensor()
...
proc th_remainder_impl*(self: Tensor; other: Tensor): Tensor {.inline.} = 
  check: atenFunction("at::_th_remainder", self.tensor, other.tensor).to(ATensor).newTensor()
...
proc th_remainder_impl_inplace*(self: Tensor; other: float): Tensor {.inline, discardable.} = 
  check: atenFunction("at::_th_remainder_", self.tensor, other).to(void); self
...
proc th_remainder_impl_inplace*(self: Tensor; other: Tensor): Tensor {.inline, discardable.} = 
  check: atenFunction("at::_th_remainder_", self.tensor, other.tensor).to(void); self
...
proc th_tril_impl*(self: Tensor; diagonal: int = 0): Tensor {.inline.} = 
  check: atenFunction("at::_th_tril", self.tensor, diagonal).to(ATensor).newTensor()
...
proc th_tril_impl_inplace*(self: Tensor; diagonal: int = 0): Tensor {.inline, discardable.} = 
  check: atenFunction("at::_th_tril_", self.tensor, diagonal).to(void); self
...
proc th_triu_impl*(self: Tensor; diagonal: int = 0): Tensor {.inline.} = 
  check: atenFunction("at::_th_triu", self.tensor, diagonal).to(ATensor).newTensor()
...
proc th_cross_impl*(self: Tensor; other: Tensor; dim: int = -1): Tensor {.inline.} = 
  check: atenFunction("at::_th_cross", self.tensor, other.tensor, dim).to(ATensor).newTensor()
...
proc th_diag_impl*(self: Tensor; diagonal: int = 0): Tensor {.inline.} = 
  check: atenFunction("at::_th_diag", self.tensor, diagonal).to(ATensor).newTensor()
...
proc th_addmm_impl_inplace*(ty: TensorType; self: Tensor; mat1: Tensor; mat2: Tensor; beta: float = 1; alpha: float = 1): Tensor {.inline, discardable.} = 
  check: ty[].atenMethod("_th_addmm_", self.tensor, mat1.tensor, mat2.tensor, beta, alpha).to(void); self
...
proc th_addr_impl_inplace*(self: Tensor; vec1: Tensor; vec2: Tensor; beta: float = 1; alpha: float = 1): Tensor {.inline, discardable.} = 
  check: atenFunction("at::_th_addr_", self.tensor, vec1.tensor, vec2.tensor, beta, alpha).to(void); self

proc th_ger_impl*(ty: TensorType; self: Tensor; vec2: Tensor): Tensor {.inline.} = 
  check: ty[].atenMethod("_th_ger", self.tensor, vec2.tensor).to(ATensor).newTensor()

proc th_ger_impl*(self: Tensor; vec2: Tensor): Tensor {.inline.} = 
  check: atenFunction("at::_th_ger", self.tensor, vec2.tensor).to(ATensor).newTensor()

proc th_mv_impl*(ty: TensorType; self: Tensor; vec: Tensor): Tensor {.inline.} = 
  check: ty[].atenMethod("_th_mv", self.tensor, vec.tensor).to(ATensor).newTensor()

proc th_mv_impl*(self: Tensor; vec: Tensor): Tensor {.inline.} = 
  check: atenFunction("at::_th_mv", self.tensor, vec.tensor).to(ATensor).newTensor()
...
proc th_addbmm_impl*(self: Tensor; batch1: Tensor; batch2: Tensor; beta: float = 1; alpha: float = 1): Tensor {.inline.} = 
  check: atenFunction("at::_th_addbmm", self.tensor, batch1.tensor, batch2.tensor, beta, alpha).to(ATensor).newTensor()
...
proc th_addbmm_impl_inplace*(self: Tensor; batch1: Tensor; batch2: Tensor; beta: float = 1; alpha: float = 1): Tensor {.inline, discardable.} = 
  check: atenFunction("at::_th_addbmm_", self.tensor, batch1.tensor, batch2.tensor, beta, alpha).to(void); self
...
proc th_addcmul_impl*(self: Tensor; tensor1: Tensor; tensor2: Tensor; value: float = 1): Tensor {.inline.} = 
  check: atenFunction("at::_th_addcmul", self.tensor, tensor1.tensor, tensor2.tensor, value).to(ATensor).newTensor()
...
proc th_addcmul_impl_inplace*(self: Tensor; tensor1: Tensor; tensor2: Tensor; value: float = 1): Tensor {.inline, discardable.} = 
  check: atenFunction("at::_th_addcmul_", self.tensor, tensor1.tensor, tensor2.tensor, value).to(void); self
...
proc th_addcdiv_impl*(self: Tensor; tensor1: Tensor; tensor2: Tensor; value: float = 1): Tensor {.inline.} = 
  check: atenFunction("at::_th_addcdiv", self.tensor, tensor1.tensor, tensor2.tensor, value).to(ATensor).newTensor()
...
proc th_addcdiv_impl_inplace*(self: Tensor; tensor1: Tensor; tensor2: Tensor; value: float = 1): Tensor {.inline, discardable.} = 
  check: atenFunction("at::_th_addcdiv_", self.tensor, tensor1.tensor, tensor2.tensor, value).to(void); self
...
proc th_gels_impl*(self: Tensor; A: Tensor): tuple[res1: Tensor, res2: Tensor] {.inline.} = 
  check: atenFunction("at::_th_gels", self.tensor, A.tensor).to(StdTuple2[ATensor, ATensor]).toNimTuple().newTensors()
...
proc th_trtrs_impl*(self: Tensor; A: Tensor; upper: bool = true; transpose: bool = false; unitriangular: bool = false): tuple[res1: Tensor, res2: Tensor] {.inline.} = 
  check: atenFunction("at::_th_trtrs", self.tensor, A.tensor, upper, transpose, unitriangular).to(StdTuple2[ATensor, ATensor]).toNimTuple().newTensors()
...
proc th_symeig_impl*(self: Tensor; eigenvectors: bool = false; upper: bool = true): tuple[res1: Tensor, res2: Tensor] {.inline.} = 
  check: atenFunction("at::_th_symeig", self.tensor, eigenvectors, upper).to(StdTuple2[ATensor, ATensor]).toNimTuple().newTensors()
...
proc th_eig_impl*(self: Tensor; eigenvectors: bool = false): tuple[res1: Tensor, res2: Tensor] {.inline.} = 
  check: atenFunction("at::_th_eig", self.tensor, eigenvectors).to(StdTuple2[ATensor, ATensor]).toNimTuple().newTensors()
...
proc th_svd_impl*(self: Tensor; some: bool = true; compute_uv: bool = true): tuple[res1: Tensor, res2: Tensor, res3: Tensor] {.inline.} = 
  check: atenFunction("at::_th_svd", self.tensor, some, compute_uv).to(StdTuple3[ATensor, ATensor, ATensor]).toNimTuple().newTensors()
...
proc th_potrf_single_impl*(ty: TensorType; self: Tensor; upper: bool = true): Tensor {.inline.} = 
  check: ty[].atenMethod("_th_potrf_single", self.tensor, upper).to(ATensor).newTensor()

proc th_potrf_single_impl*(self: Tensor; upper: bool = true): Tensor {.inline.} = 
  check: atenFunction("at::_th_potrf_single", self.tensor, upper).to(ATensor).newTensor()

proc th_potrs_single_impl*(ty: TensorType; self: Tensor; input2: Tensor; upper: bool = true): Tensor {.inline.} = 
  check: ty[].atenMethod("_th_potrs_single", self.tensor, input2.tensor, upper).to(ATensor).newTensor()

proc th_potrs_single_impl*(self: Tensor; input2: Tensor; upper: bool = true): Tensor {.inline.} = 
  check: atenFunction("at::_th_potrs_single", self.tensor, input2.tensor, upper).to(ATensor).newTensor()
...
proc th_potri_impl*(self: Tensor; upper: bool = true): Tensor {.inline.} = 
  check: atenFunction("at::_th_potri", self.tensor, upper).to(ATensor).newTensor()
...
proc th_pstrf_impl*(self: Tensor; upper: bool = true; tol: float = -1): tuple[res1: Tensor, res2: Tensor] {.inline.} = 
  check: atenFunction("at::_th_pstrf", self.tensor, upper, tol).to(StdTuple2[ATensor, ATensor]).toNimTuple().newTensors()
...
proc th_qr_impl*(self: Tensor): tuple[res1: Tensor, res2: Tensor] {.inline.} = 
  check: atenFunction("at::_th_qr", self.tensor).to(StdTuple2[ATensor, ATensor]).toNimTuple().newTensors()
...
proc th_geqrf_impl*(self: Tensor): tuple[res1: Tensor, res2: Tensor] {.inline.} = 
  check: atenFunction("at::_th_geqrf", self.tensor).to(StdTuple2[ATensor, ATensor]).toNimTuple().newTensors()
...
proc th_orgqr_impl*(self: Tensor; input2: Tensor): Tensor {.inline.} = 
  check: atenFunction("at::_th_orgqr", self.tensor, input2.tensor).to(ATensor).newTensor()
...
proc th_ormqr_impl*(self: Tensor; input2: Tensor; input3: Tensor; left: bool = true; transpose: bool = false): Tensor {.inline.} = 
  check: atenFunction("at::_th_ormqr", self.tensor, input2.tensor, input3.tensor, left, transpose).to(ATensor).newTensor()
...
proc th_btrifact_impl*(self: Tensor; pivot: bool = true): tuple[result_special: Tensor, pivots: Tensor] {.inline.} = 
  check: atenFunction("at::_th_btrifact", self.tensor, pivot).to(StdTuple2[ATensor, ATensor]).toNimTuple().newTensors()
...
proc th_btrifact_with_info_impl*(self: Tensor; pivot: bool = true): tuple[result_special: Tensor, pivots: Tensor, info: Tensor] {.inline.} = 
  check: atenFunction("at::_th_btrifact_with_info", self.tensor, pivot).to(StdTuple3[ATensor, ATensor, ATensor]).toNimTuple().newTensors()
...
proc th_btrisolve_impl*(self: Tensor; LU_data: Tensor; LU_pivots: Tensor): Tensor {.inline.} = 
  check: atenFunction("at::_th_btrisolve", self.tensor, LU_data.tensor, LU_pivots.tensor).to(ATensor).newTensor()
...
proc th_random_impl_inplace*(ty: TensorType; self: Tensor; from_special: int; to_special: int; generator: Generator = nil): Tensor {.inline, discardable.} = 
  check: ty[].atenMethod("_th_random_", self.tensor, from_special, to_special, generator).to(void); self
...
proc th_random_impl_inplace*(self: Tensor; from_special: int; to_special: int; generator: Generator = nil): Tensor {.inline, discardable.} = 
  check: atenFunction("at::_th_random_", self.tensor, from_special, to_special, generator).to(void); self

proc th_random_impl_inplace*(ty: TensorType; self: Tensor; to_special: int; generator: Generator = nil): Tensor {.inline, discardable.} = 
  check: ty[].atenMethod("_th_random_", self.tensor, to_special, generator).to(void); self

proc th_random_impl_inplace*(self: Tensor; to_special: int; generator: Generator = nil): Tensor {.inline, discardable.} = 
  check: atenFunction("at::_th_random_", self.tensor, to_special, generator).to(void); self
...
proc th_random_impl_inplace*(self: Tensor; generator: Generator = nil): Tensor {.inline, discardable.} = 
  check: atenFunction("at::_th_random_", self.tensor, generator).to(void); self
...
proc th_multinomial_impl*(self: Tensor; num_samples: int; replacement: bool = false; generator: Generator = nil): Tensor {.inline.} = 
  check: atenFunction("at::_th_multinomial", self.tensor, num_samples, replacement, generator).to(ATensor).newTensor()
...
proc th_uniform_impl_inplace*(ty: TensorType; self: Tensor; from_special: float64 = 0; to_special: float64 = 1; generator: Generator = nil): Tensor {.inline, discardable.} = 
  check: ty[].atenMethod("_th_uniform_", self.tensor, from_special, to_special, generator).to(void); self
...
proc th_uniform_impl_inplace*(self: Tensor; from_special: float64 = 0; to_special: float64 = 1; generator: Generator = nil): Tensor {.inline, discardable.} = 
  check: atenFunction("at::_th_uniform_", self.tensor, from_special, to_special, generator).to(void); self

proc th_normal_impl*(ty: TensorType; mean: Tensor; std: float64 = 1; generator: Generator = nil): Tensor {.inline.} = 
  check: ty[].atenMethod("_th_normal", mean.tensor, std, generator).to(ATensor).newTensor()

proc th_normal_impl*(mean: Tensor; std: float64 = 1; generator: Generator = nil): Tensor {.inline.} = 
  check: atenFunction("at::_th_normal", mean.tensor, std, generator).to(ATensor).newTensor()

proc th_normal_impl*(ty: TensorType; mean: float64; std: Tensor; generator: Generator = nil): Tensor {.inline.} = 
  check: ty[].atenMethod("_th_normal", mean, std.tensor, generator).to(ATensor).newTensor()

proc th_normal_impl*(mean: float64; std: Tensor; generator: Generator = nil): Tensor {.inline.} = 
  check: atenFunction("at::_th_normal", mean, std.tensor, generator).to(ATensor).newTensor()

proc th_normal_impl*(ty: TensorType; mean: Tensor; std: Tensor; generator: Generator = nil): Tensor {.inline.} = 
  check: ty[].atenMethod("_th_normal", mean.tensor, std.tensor, generator).to(ATensor).newTensor()

proc th_normal_impl*(mean: Tensor; std: Tensor; generator: Generator = nil): Tensor {.inline.} = 
  check: atenFunction("at::_th_normal", mean.tensor, std.tensor, generator).to(ATensor).newTensor()
...
proc th_normal_impl_inplace*(self: Tensor; mean: float64 = 0; std: float64 = 1; generator: Generator = nil): Tensor {.inline, discardable.} = 
  check: atenFunction("at::_th_normal_", self.tensor, mean, std, generator).to(void); self
...
proc th_cauchy_impl_inplace*(self: Tensor; median: float64 = 0; sigma: float64 = 1; generator: Generator = nil): Tensor {.inline, discardable.} = 
  check: atenFunction("at::_th_cauchy_", self.tensor, median, sigma, generator).to(void); self
...
proc th_log_normal_impl_inplace*(self: Tensor; mean: float64 = 1; std: float64 = 2; generator: Generator = nil): Tensor {.inline, discardable.} = 
  check: atenFunction("at::_th_log_normal_", self.tensor, mean, std, generator).to(void); self
...
proc th_exponential_impl_inplace*(self: Tensor; lambd: float64 = 1; generator: Generator = nil): Tensor {.inline, discardable.} = 
  check: atenFunction("at::_th_exponential_", self.tensor, lambd, generator).to(void); self
...
proc th_geometric_impl_inplace*(self: Tensor; p: float64; generator: Generator = nil): Tensor {.inline, discardable.} = 
  check: atenFunction("at::_th_geometric_", self.tensor, p, generator).to(void); self
...
proc th_alias_impl*(ty: TensorType; self: Tensor): Tensor {.inline.} = 
  check: ty[].atenMethod("_th_alias", self.tensor).to(ATensor).newTensor()

proc th_alias_impl*(self: Tensor): Tensor {.inline.} = 
  check: atenFunction("at::_th_alias", self.tensor).to(ATensor).newTensor()
...
proc copy_impl_inplace*(ty: TensorType; self: Tensor; src: Tensor): Tensor {.inline, discardable.} = 
  check: ty[].atenMethod("_copy_", self.tensor, src.tensor).to(void); self

proc copy_impl_inplace*(self: Tensor; src: Tensor): Tensor {.inline, discardable.} = 
  check: atenFunction("at::_copy_", self.tensor, src.tensor).to(void); self
...
proc diag_embed*(ty: TensorType; self: Tensor; offset: int = 0; dim1: int = -2; dim2: int = -1): Tensor {.inline.} = 
  check: ty[].atenMethod("diag_embed", self.tensor, offset, dim1, dim2).to(ATensor).newTensor()
...
proc native_batch_norm_backward*(ty: TensorType; grad_out: Tensor; input: Tensor; weight: Tensor; running_mean: Tensor; running_var: Tensor; save_mean: Tensor; save_invstd: Tensor; train: bool; eps: float64; output_mask: StdArray[bool, 3]): tuple[result0: Tensor, result1: Tensor, result2: Tensor] {.inline.} = 
  check: ty[].atenMethod("native_batch_norm_backward", grad_out.tensor, input.tensor, weight.tensor, running_mean.tensor, running_var.tensor, save_mean.tensor, save_invstd.tensor, train, eps, output_mask).to(StdTuple3[ATensor, ATensor, ATensor]).toNimTuple().newTensors()
...
proc native_batch_norm_backward*(grad_out: Tensor; input: Tensor; weight: Tensor; running_mean: Tensor; running_var: Tensor; save_mean: Tensor; save_invstd: Tensor; train: bool; eps: float64; output_mask: StdArray[bool, 3]): tuple[result0: Tensor, result1: Tensor, result2: Tensor] {.inline.} = 
  check: atenFunction("at::native_batch_norm_backward", grad_out.tensor, input.tensor, weight.tensor, running_mean.tensor, running_var.tensor, save_mean.tensor, save_invstd.tensor, train, eps, output_mask).to(StdTuple3[ATensor, ATensor, ATensor]).toNimTuple().newTensors()
...
proc cosine_similarity*(ty: TensorType; x1: Tensor; x2: Tensor; dim: int = 1; eps: float64): Tensor {.inline.} = 
  check: ty[].atenMethod("cosine_similarity", x1.tensor, x2.tensor, dim, eps).to(ATensor).newTensor()

proc cosine_similarity*(x1: Tensor; x2: Tensor; dim: int = 1; eps: float64): Tensor {.inline.} = 
  check: atenFunction("at::cosine_similarity", x1.tensor, x2.tensor, dim, eps).to(ATensor).newTensor()
...
proc lerp_inplace*(ty: TensorType; self: Tensor; end_special: Tensor; weight: float): Tensor {.inline, discardable.} = 
  check: ty[].atenMethod("lerp_", self.tensor, end_special.tensor, weight).to(void); self

proc lerp_inplace*(self: Tensor; end_special: Tensor; weight: float): Tensor {.inline, discardable.} = 
  check: self.tensor.atenMethod("lerp_", end_special.tensor, weight).to(void); self
...
proc cholesky_helper_impl*(ty: TensorType; self: Tensor; upper: bool): Tensor {.inline.} = 
  check: ty[].atenMethod("_cholesky_helper", self.tensor, upper).to(ATensor).newTensor()

proc cholesky_helper_impl*(self: Tensor; upper: bool): Tensor {.inline.} = 
  check: atenFunction("at::_cholesky_helper", self.tensor, upper).to(ATensor).newTensor()
...
proc potrs_helper_impl*(ty: TensorType; self: Tensor; A: Tensor; upper: bool): Tensor {.inline.} = 
  check: ty[].atenMethod("_potrs_helper", self.tensor, A.tensor, upper).to(ATensor).newTensor()

proc potrs_helper_impl*(self: Tensor; A: Tensor; upper: bool): Tensor {.inline.} = 
  check: atenFunction("at::_potrs_helper", self.tensor, A.tensor, upper).to(ATensor).newTensor()
...
proc lerp*(ty: TensorType; self: Tensor; end_special: Tensor; weight: float): Tensor {.inline.} = 
  check: ty[].atenMethod("lerp", self.tensor, end_special.tensor, weight).to(ATensor).newTensor()

proc lerp*(self: Tensor; end_special: Tensor; weight: float): Tensor {.inline.} = 
  check: self.tensor.atenMethod("lerp", end_special.tensor, weight).to(ATensor).newTensor()
...
proc min*(ty: TensorType; self: Tensor): Tensor {.inline.} = 
  check: ty[].atenMethod("min", self.tensor).to(ATensor).newTensor()
...
proc max*(ty: TensorType; self: Tensor): Tensor {.inline.} = 
  check: ty[].atenMethod("max", self.tensor).to(ATensor).newTensor()
...
proc median*(ty: TensorType; self: Tensor): Tensor {.inline.} = 
  check: ty[].atenMethod("median", self.tensor).to(ATensor).newTensor()
...
proc all*(ty: TensorType; self: Tensor): Tensor {.inline.} = 
  check: ty[].atenMethod("all", self.tensor).to(ATensor).newTensor()
...
proc any*(ty: TensorType; self: Tensor): Tensor {.inline.} = 
  check: ty[].atenMethod("any", self.tensor).to(ATensor).newTensor()
