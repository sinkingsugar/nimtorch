...
proc resize_inplace*(ty: TensorType; self: Tensor; size: openarray[SomeInteger]): Tensor = 
  ty.atenMethod("resize_", self.tensor, size.toAIntList()).to(ATensor).newTensor()

proc resize_inplace*(self: Tensor; size: openarray[SomeInteger]): Tensor = 
  self.tensor.atenMethod("resize_", size.toAIntList()).to(ATensor).newTensor()

proc set_inplace*(ty: TensorType; self: Tensor; source: AStorage): Tensor = 
  ty.atenMethod("set_", self.tensor, source).to(ATensor).newTensor()

proc set_inplace*(self: Tensor; source: AStorage): Tensor = 
  self.tensor.atenMethod("set_", source).to(ATensor).newTensor()
...
proc set_inplace*(ty: TensorType; self: Tensor; source: AStorage; storage_offset: int64; size: openarray[SomeInteger]; stride: openarray[SomeInteger]): Tensor = 
  ty.atenMethod("set_", self.tensor, source, storage_offset, size.toAIntList(), stride.toAIntList()).to(ATensor).newTensor()
...
proc set_inplace*(self: Tensor; source: AStorage; storage_offset: int64; size: openarray[SomeInteger]; stride: openarray[SomeInteger]): Tensor = 
  self.tensor.atenMethod("set_", source, storage_offset, size.toAIntList(), stride.toAIntList()).to(ATensor).newTensor()

proc set_inplace*(ty: TensorType; self: Tensor; source: Tensor): Tensor = 
  ty.atenMethod("set_", self.tensor, source.tensor).to(ATensor).newTensor()

proc set_inplace*(self: Tensor; source: Tensor): Tensor = 
  self.tensor.atenMethod("set_", source.tensor).to(ATensor).newTensor()

proc set_inplace*(ty: TensorType; self: Tensor): Tensor = 
  ty.atenMethod("set_", self.tensor).to(ATensor).newTensor()

proc set_inplace*(self: Tensor): Tensor = 
  self.tensor.atenMethod("set_").to(ATensor).newTensor()

proc fill_internal_inplace*(ty: TensorType; self: Tensor; value: float): Tensor = 
  ty.atenMethod("_fill_", self.tensor, value).to(ATensor).newTensor()

proc fill_internal_inplace*(self: Tensor; value: float): Tensor = 
  self.tensor.atenMethod("_fill_", value).to(ATensor).newTensor()

proc fill_internal_inplace*(ty: TensorType; self: Tensor; value: Tensor): Tensor = 
  ty.atenMethod("_fill_", self.tensor, value.tensor).to(ATensor).newTensor()

proc fill_internal_inplace*(self: Tensor; value: Tensor): Tensor = 
  self.tensor.atenMethod("_fill_", value.tensor).to(ATensor).newTensor()
...
proc masked_scatter_inplace*(ty: TensorType; self: Tensor; mask: Tensor; source: Tensor): Tensor = 
  ty.atenMethod("masked_scatter_", self.tensor, mask.tensor, source.tensor).to(ATensor).newTensor()

proc masked_scatter_inplace*(self: Tensor; mask: Tensor; source: Tensor): Tensor = 
  self.tensor.atenMethod("masked_scatter_", mask.tensor, source.tensor).to(ATensor).newTensor()
...
proc th_resize_as_inplace*(ty: TensorType; self: Tensor; the_template: Tensor): Tensor = 
  ty.atenMethod("th_resize_as_", self.tensor, the_template.tensor).to(ATensor).newTensor()

proc th_resize_as_inplace*(self: Tensor; the_template: Tensor): Tensor = 
  atenFunction("at::th_resize_as_", self.tensor, the_template.tensor).to(ATensor).newTensor()
...
proc indexCopy_internal_inplace*(ty: TensorType; self: Tensor; dim: int64; index: Tensor; source: Tensor): Tensor = 
  ty.atenMethod("_indexCopy_", self.tensor, dim, index.tensor, source.tensor).to(ATensor).newTensor()

proc indexCopy_internal_inplace*(self: Tensor; dim: int64; index: Tensor; source: Tensor): Tensor = 
  self.tensor.atenMethod("_indexCopy_", dim, index.tensor, source.tensor).to(ATensor).newTensor()
...
proc iand_builtin*(ty: TensorType; self: Tensor; other: float): Tensor = 
  ty.atenMethod("__iand__", self.tensor, other).to(ATensor).newTensor()

proc iand_builtin*(self: Tensor; other: float): Tensor = 
  self.tensor.atenMethod("__iand__", other).to(ATensor).newTensor()

proc iand_builtin*(ty: TensorType; self: Tensor; other: Tensor): Tensor = 
  ty.atenMethod("__iand__", self.tensor, other.tensor).to(ATensor).newTensor()

proc iand_builtin*(self: Tensor; other: Tensor): Tensor = 
  self.tensor.atenMethod("__iand__", other.tensor).to(ATensor).newTensor()
...
proc ior_builtin*(ty: TensorType; self: Tensor; other: float): Tensor = 
  ty.atenMethod("__ior__", self.tensor, other).to(ATensor).newTensor()

proc ior_builtin*(self: Tensor; other: float): Tensor = 
  self.tensor.atenMethod("__ior__", other).to(ATensor).newTensor()

proc ior_builtin*(ty: TensorType; self: Tensor; other: Tensor): Tensor = 
  ty.atenMethod("__ior__", self.tensor, other.tensor).to(ATensor).newTensor()

proc ior_builtin*(self: Tensor; other: Tensor): Tensor = 
  self.tensor.atenMethod("__ior__", other.tensor).to(ATensor).newTensor()
...
proc ixor_builtin*(ty: TensorType; self: Tensor; other: float): Tensor = 
  ty.atenMethod("__ixor__", self.tensor, other).to(ATensor).newTensor()

proc ixor_builtin*(self: Tensor; other: float): Tensor = 
  self.tensor.atenMethod("__ixor__", other).to(ATensor).newTensor()

proc ixor_builtin*(ty: TensorType; self: Tensor; other: Tensor): Tensor = 
  ty.atenMethod("__ixor__", self.tensor, other.tensor).to(ATensor).newTensor()

proc ixor_builtin*(self: Tensor; other: Tensor): Tensor = 
  self.tensor.atenMethod("__ixor__", other.tensor).to(ATensor).newTensor()
...
proc ilshift_builtin*(ty: TensorType; self: Tensor; other: float): Tensor = 
  ty.atenMethod("__ilshift__", self.tensor, other).to(ATensor).newTensor()

proc ilshift_builtin*(self: Tensor; other: float): Tensor = 
  self.tensor.atenMethod("__ilshift__", other).to(ATensor).newTensor()

proc ilshift_builtin*(ty: TensorType; self: Tensor; other: Tensor): Tensor = 
  ty.atenMethod("__ilshift__", self.tensor, other.tensor).to(ATensor).newTensor()

proc ilshift_builtin*(self: Tensor; other: Tensor): Tensor = 
  self.tensor.atenMethod("__ilshift__", other.tensor).to(ATensor).newTensor()
...
proc irshift_builtin*(ty: TensorType; self: Tensor; other: float): Tensor = 
  ty.atenMethod("__irshift__", self.tensor, other).to(ATensor).newTensor()

proc irshift_builtin*(self: Tensor; other: float): Tensor = 
  self.tensor.atenMethod("__irshift__", other).to(ATensor).newTensor()

proc irshift_builtin*(ty: TensorType; self: Tensor; other: Tensor): Tensor = 
  ty.atenMethod("__irshift__", self.tensor, other.tensor).to(ATensor).newTensor()

proc irshift_builtin*(self: Tensor; other: Tensor): Tensor = 
  self.tensor.atenMethod("__irshift__", other.tensor).to(ATensor).newTensor()
...
proc lgamma_inplace*(ty: TensorType; self: Tensor): Tensor = 
  ty.atenMethod("lgamma_", self.tensor).to(ATensor).newTensor()

proc lgamma_inplace*(self: Tensor): Tensor = 
  self.tensor.atenMethod("lgamma_").to(ATensor).newTensor()
...
proc digamma_inplace*(ty: TensorType; self: Tensor): Tensor = 
  ty.atenMethod("digamma_", self.tensor).to(ATensor).newTensor()

proc digamma_inplace*(self: Tensor): Tensor = 
  self.tensor.atenMethod("digamma_").to(ATensor).newTensor()
...
proc polygamma_inplace*(ty: TensorType; self: Tensor; n: int64): Tensor = 
  ty.atenMethod("polygamma_", self.tensor, n).to(ATensor).newTensor()

proc polygamma_inplace*(self: Tensor; n: int64): Tensor = 
  self.tensor.atenMethod("polygamma_", n).to(ATensor).newTensor()
...
proc erfinv_inplace*(ty: TensorType; self: Tensor): Tensor = 
  ty.atenMethod("erfinv_", self.tensor).to(ATensor).newTensor()

proc erfinv_inplace*(self: Tensor): Tensor = 
  self.tensor.atenMethod("erfinv_").to(ATensor).newTensor()
...
proc frac_inplace*(ty: TensorType; self: Tensor): Tensor = 
  ty.atenMethod("frac_", self.tensor).to(ATensor).newTensor()

proc frac_inplace*(self: Tensor): Tensor = 
  self.tensor.atenMethod("frac_").to(ATensor).newTensor()
...
proc renorm_inplace*(ty: TensorType; self: Tensor; p: float; dim: int64; maxnorm: float): Tensor = 
  ty.atenMethod("renorm_", self.tensor, p, dim, maxnorm).to(ATensor).newTensor()

proc renorm_inplace*(self: Tensor; p: float; dim: int64; maxnorm: float): Tensor = 
  self.tensor.atenMethod("renorm_", p, dim, maxnorm).to(ATensor).newTensor()
...
proc reciprocal_inplace*(ty: TensorType; self: Tensor): Tensor = 
  ty.atenMethod("reciprocal_", self.tensor).to(ATensor).newTensor()

proc reciprocal_inplace*(self: Tensor): Tensor = 
  self.tensor.atenMethod("reciprocal_").to(ATensor).newTensor()
...
proc neg_inplace*(ty: TensorType; self: Tensor): Tensor = 
  ty.atenMethod("neg_", self.tensor).to(ATensor).newTensor()

proc neg_inplace*(self: Tensor): Tensor = 
  self.tensor.atenMethod("neg_").to(ATensor).newTensor()
...
proc atan2_inplace*(ty: TensorType; self: Tensor; other: Tensor): Tensor = 
  ty.atenMethod("atan2_", self.tensor, other.tensor).to(ATensor).newTensor()

proc atan2_inplace*(self: Tensor; other: Tensor): Tensor = 
  self.tensor.atenMethod("atan2_", other.tensor).to(ATensor).newTensor()
...
proc pow_inplace*(ty: TensorType; self: Tensor; exponent: float): Tensor = 
  ty.atenMethod("pow_", self.tensor, exponent).to(ATensor).newTensor()

proc pow_inplace*(self: Tensor; exponent: float): Tensor = 
  self.tensor.atenMethod("pow_", exponent).to(ATensor).newTensor()

proc pow_inplace*(ty: TensorType; self: Tensor; exponent: Tensor): Tensor = 
  ty.atenMethod("pow_", self.tensor, exponent.tensor).to(ATensor).newTensor()

proc pow_inplace*(self: Tensor; exponent: Tensor): Tensor = 
  self.tensor.atenMethod("pow_", exponent.tensor).to(ATensor).newTensor()
...
proc lerp_inplace*(ty: TensorType; self: Tensor; end_name: Tensor; weight: float): Tensor = 
  ty.atenMethod("lerp_", self.tensor, end_name.tensor, weight).to(ATensor).newTensor()

proc lerp_inplace*(self: Tensor; end_name: Tensor; weight: float): Tensor = 
  self.tensor.atenMethod("lerp_", end_name.tensor, weight).to(ATensor).newTensor()
...
proc th_zero_inplace*(ty: TensorType; self: Tensor): Tensor = 
  ty.atenMethod("th_zero_", self.tensor).to(ATensor).newTensor()

proc th_zero_inplace*(self: Tensor): Tensor = 
  atenFunction("at::th_zero_", self.tensor).to(ATensor).newTensor()
...
proc sign_inplace*(ty: TensorType; self: Tensor): Tensor = 
  ty.atenMethod("sign_", self.tensor).to(ATensor).newTensor()

proc sign_inplace*(self: Tensor): Tensor = 
  self.tensor.atenMethod("sign_").to(ATensor).newTensor()
...
proc fmod_inplace*(ty: TensorType; self: Tensor; other: float): Tensor = 
  ty.atenMethod("fmod_", self.tensor, other).to(ATensor).newTensor()

proc fmod_inplace*(self: Tensor; other: float): Tensor = 
  self.tensor.atenMethod("fmod_", other).to(ATensor).newTensor()

proc fmod_inplace*(ty: TensorType; self: Tensor; other: Tensor): Tensor = 
  ty.atenMethod("fmod_", self.tensor, other.tensor).to(ATensor).newTensor()

proc fmod_inplace*(self: Tensor; other: Tensor): Tensor = 
  self.tensor.atenMethod("fmod_", other.tensor).to(ATensor).newTensor()
...
proc remainder_inplace*(ty: TensorType; self: Tensor; other: float): Tensor = 
  ty.atenMethod("remainder_", self.tensor, other).to(ATensor).newTensor()

proc remainder_inplace*(self: Tensor; other: float): Tensor = 
  self.tensor.atenMethod("remainder_", other).to(ATensor).newTensor()

proc remainder_inplace*(ty: TensorType; self: Tensor; other: Tensor): Tensor = 
  ty.atenMethod("remainder_", self.tensor, other.tensor).to(ATensor).newTensor()

proc remainder_inplace*(self: Tensor; other: Tensor): Tensor = 
  self.tensor.atenMethod("remainder_", other.tensor).to(ATensor).newTensor()
...
proc tril_inplace*(ty: TensorType; self: Tensor; diagonal: int64 = 0): Tensor = 
  ty.atenMethod("tril_", self.tensor, diagonal).to(ATensor).newTensor()

proc tril_inplace*(self: Tensor; diagonal: int64 = 0): Tensor = 
  self.tensor.atenMethod("tril_", diagonal).to(ATensor).newTensor()
...
proc triu_inplace*(ty: TensorType; self: Tensor; diagonal: int64 = 0): Tensor = 
  ty.atenMethod("triu_", self.tensor, diagonal).to(ATensor).newTensor()

proc triu_inplace*(self: Tensor; diagonal: int64 = 0): Tensor = 
  self.tensor.atenMethod("triu_", diagonal).to(ATensor).newTensor()
...
proc th_addmm_inplace*(ty: TensorType; self: Tensor; mat1: Tensor; mat2: Tensor; beta: float = 1; alpha: float = 1): Tensor = 
  ty.atenMethod("th_addmm_", self.tensor, mat1.tensor, mat2.tensor, beta, alpha).to(ATensor).newTensor()

proc th_addmm_inplace*(self: Tensor; mat1: Tensor; mat2: Tensor; beta: float = 1; alpha: float = 1): Tensor = 
  atenFunction("at::th_addmm_", self.tensor, mat1.tensor, mat2.tensor, beta, alpha).to(ATensor).newTensor()
...
proc addmv_internal_inplace*(ty: TensorType; self: Tensor; mat: Tensor; vec: Tensor; beta: float = 1; alpha: float = 1): Tensor = 
  ty.atenMethod("_addmv_", self.tensor, mat.tensor, vec.tensor, beta, alpha).to(ATensor).newTensor()

proc addmv_internal_inplace*(self: Tensor; mat: Tensor; vec: Tensor; beta: float = 1; alpha: float = 1): Tensor = 
  self.tensor.atenMethod("_addmv_", mat.tensor, vec.tensor, beta, alpha).to(ATensor).newTensor()
...
proc addr_internal_inplace*(ty: TensorType; self: Tensor; vec1: Tensor; vec2: Tensor; beta: float = 1; alpha: float = 1): Tensor = 
  ty.atenMethod("_addr_", self.tensor, vec1.tensor, vec2.tensor, beta, alpha).to(ATensor).newTensor()

proc addr_internal_inplace*(self: Tensor; vec1: Tensor; vec2: Tensor; beta: float = 1; alpha: float = 1): Tensor = 
  self.tensor.atenMethod("_addr_", vec1.tensor, vec2.tensor, beta, alpha).to(ATensor).newTensor()
...
proc addbmm_inplace*(ty: TensorType; self: Tensor; batch1: Tensor; batch2: Tensor; beta: float = 1; alpha: float = 1): Tensor = 
  ty.atenMethod("addbmm_", self.tensor, batch1.tensor, batch2.tensor, beta, alpha).to(ATensor).newTensor()

proc addbmm_inplace*(self: Tensor; batch1: Tensor; batch2: Tensor; beta: float = 1; alpha: float = 1): Tensor = 
  self.tensor.atenMethod("addbmm_", batch1.tensor, batch2.tensor, beta, alpha).to(ATensor).newTensor()
...
proc baddbmm_inplace*(ty: TensorType; self: Tensor; batch1: Tensor; batch2: Tensor; beta: float = 1; alpha: float = 1): Tensor = 
  ty.atenMethod("baddbmm_", self.tensor, batch1.tensor, batch2.tensor, beta, alpha).to(ATensor).newTensor()

proc baddbmm_inplace*(self: Tensor; batch1: Tensor; batch2: Tensor; beta: float = 1; alpha: float = 1): Tensor = 
  self.tensor.atenMethod("baddbmm_", batch1.tensor, batch2.tensor, beta, alpha).to(ATensor).newTensor()
...
proc addcmul_inplace*(ty: TensorType; self: Tensor; tensor1: Tensor; tensor2: Tensor; value: float = 1): Tensor = 
  ty.atenMethod("addcmul_", self.tensor, tensor1.tensor, tensor2.tensor, value).to(ATensor).newTensor()

proc addcmul_inplace*(self: Tensor; tensor1: Tensor; tensor2: Tensor; value: float = 1): Tensor = 
  self.tensor.atenMethod("addcmul_", tensor1.tensor, tensor2.tensor, value).to(ATensor).newTensor()
...
proc addcdiv_inplace*(ty: TensorType; self: Tensor; tensor1: Tensor; tensor2: Tensor; value: float = 1): Tensor = 
  ty.atenMethod("addcdiv_", self.tensor, tensor1.tensor, tensor2.tensor, value).to(ATensor).newTensor()

proc addcdiv_inplace*(self: Tensor; tensor1: Tensor; tensor2: Tensor; value: float = 1): Tensor = 
  self.tensor.atenMethod("addcdiv_", tensor1.tensor, tensor2.tensor, value).to(ATensor).newTensor()
...
proc random_inplace*(ty: TensorType; self: Tensor; from_name: int64; to_name: int64; generator: Generator = nil): Tensor

proc random_inplace*(self: Tensor; from_name: int64; to_name: int64; generator: Generator = nil): Tensor

proc random_inplace*(ty: TensorType; self: Tensor; to_name: int64; generator: Generator = nil): Tensor

proc random_inplace*(self: Tensor; to_name: int64; generator: Generator = nil): Tensor

proc random_inplace*(ty: TensorType; self: Tensor; generator: Generator = nil): Tensor

proc random_inplace*(self: Tensor; generator: Generator = nil): Tensor

proc multinomial*(ty: TensorType; self: Tensor; num_samples: int64; replacement: bool = false; generator: Generator = nil): Tensor = 
  ty.atenMethod("multinomial", self.tensor, num_samples, replacement, generator).to(ATensor).newTensor()

proc multinomial*(self: Tensor; num_samples: int64; replacement: bool = false; generator: Generator = nil): Tensor = 
  self.tensor.atenMethod("multinomial", num_samples, replacement, generator).to(ATensor).newTensor()

proc uniform_inplace*(ty: TensorType; self: Tensor; from_name: float64 = 0; to_name: float64 = 1; generator: Generator = nil): Tensor

proc uniform_inplace*(self: Tensor; from_name: float64 = 0; to_name: float64 = 1; generator: Generator = nil): Tensor

proc normal*(ty: TensorType; mean: Tensor; std: float64 = 1; generator: Generator = nil): Tensor = 
  ty.atenMethod("normal", mean.tensor, std, generator).to(ATensor).newTensor()

proc normal*(mean: Tensor; std: float64 = 1; generator: Generator = nil): Tensor = 
  atenFunction("at::normal", mean.tensor, std, generator).to(ATensor).newTensor()

proc normal*(ty: TensorType; mean: float64; std: Tensor; generator: Generator = nil): Tensor = 
  ty.atenMethod("normal", mean, std.tensor, generator).to(ATensor).newTensor()

proc normal*(mean: float64; std: Tensor; generator: Generator = nil): Tensor = 
  atenFunction("at::normal", mean, std.tensor, generator).to(ATensor).newTensor()

proc normal*(ty: TensorType; mean: Tensor; std: Tensor; generator: Generator = nil): Tensor = 
  ty.atenMethod("normal", mean.tensor, std.tensor, generator).to(ATensor).newTensor()

proc normal*(mean: Tensor; std: Tensor; generator: Generator = nil): Tensor = 
  atenFunction("at::normal", mean.tensor, std.tensor, generator).to(ATensor).newTensor()

proc normal_inplace*(ty: TensorType; self: Tensor; mean: float64 = 0; std: float64 = 1; generator: Generator = nil): Tensor

proc normal_inplace*(self: Tensor; mean: float64 = 0; std: float64 = 1; generator: Generator = nil): Tensor

proc cauchy_inplace*(ty: TensorType; self: Tensor; median: float64 = 0; sigma: float64 = 1; generator: Generator = nil): Tensor

proc cauchy_inplace*(self: Tensor; median: float64 = 0; sigma: float64 = 1; generator: Generator = nil): Tensor

proc log_normal_inplace*(ty: TensorType; self: Tensor; mean: float64 = 1; std: float64 = 2; generator: Generator = nil): Tensor

proc log_normal_inplace*(self: Tensor; mean: float64 = 1; std: float64 = 2; generator: Generator = nil): Tensor

proc exponential_inplace*(ty: TensorType; self: Tensor; lambd: float64 = 1; generator: Generator = nil): Tensor

proc exponential_inplace*(self: Tensor; lambd: float64 = 1; generator: Generator = nil): Tensor

proc geometric_inplace*(ty: TensorType; self: Tensor; p: float64; generator: Generator = nil): Tensor

proc geometric_inplace*(self: Tensor; p: float64; generator: Generator = nil): Tensor

proc bernoulli_internal_inplace*(ty: TensorType; self: Tensor; p: float64; generator: Generator = nil): Tensor = 
  ty.atenMethod("_bernoulli_", self.tensor, p, generator).to(ATensor).newTensor()

proc bernoulli_internal_inplace*(self: Tensor; p: float64; generator: Generator = nil): Tensor = 
  self.tensor.atenMethod("_bernoulli_", p, generator).to(ATensor).newTensor()

proc th_bernoulli_internal*(ty: TensorType; self: Tensor; generator: Generator = nil): Tensor = 
  ty.atenMethod("_th_bernoulli", self.tensor, generator).to(ATensor).newTensor()

proc th_bernoulli_internal*(self: Tensor; generator: Generator = nil): Tensor = 
...
proc copy_ignoring_overlaps_internal_inplace*(ty: TensorType; self: Tensor; src: Tensor): Tensor = 
  ty.atenMethod("_copy_ignoring_overlaps_", self.tensor, src.tensor).to(ATensor).newTensor()

proc copy_ignoring_overlaps_internal_inplace*(self: Tensor; src: Tensor): Tensor = 
  self.tensor.atenMethod("_copy_ignoring_overlaps_", src.tensor).to(ATensor).newTensor()

proc cat_internal*(ty: TensorType; tensors: openarray[Tensor]; dim: int64 = 0): Tensor = 
  ty.atenMethod("_cat", tensors.toATensors(), dim).to(ATensor).newTensor()

proc cat_internal*(tensors: openarray[Tensor]; dim: int64 = 0): Tensor = 
...
proc elu_inplace*(ty: TensorType; self: Tensor; alpha: float; scale: float; input_scale: float): Tensor = 
  ty.atenMethod("elu_forward_", self.tensor, alpha, scale, input_scale).to(ATensor).newTensor()

proc elu_inplace*(self: Tensor; alpha: float; scale: float; input_scale: float): Tensor = 
  atenFunction("at::elu_forward_", self.tensor, alpha, scale, input_scale).to(ATensor).newTensor()
...
proc rrelu_with_noise*(ty: TensorType; self: Tensor; noise: Tensor; lower: float; upper: float; training: bool; generator: Generator): Tensor

proc rrelu_with_noise*(self: Tensor; noise: Tensor; lower: float; upper: float; training: bool; generator: Generator): Tensor
...
proc rrelu_with_noise_inplace*(ty: TensorType; self: Tensor; noise: Tensor; lower: float; upper: float; training: bool; generator: Generator): Tensor

proc rrelu_with_noise_inplace*(self: Tensor; noise: Tensor; lower: float; upper: float; training: bool; generator: Generator): Tensor
...
proc cudnn_rnn_flatten_weight_internal*(ty: TensorType; weight_arr: openarray[Tensor]; weight_stride0: int64; input_size: int64; mode: int64; hidden_size: int64; num_layers: int64; batch_first: bool; bidirectional: bool): Tensor = 
...
proc fused_dropout_internal*(ty: TensorType; self: Tensor; p: float64; generator: Generator = nil): tuple[result0: Tensor, result1: Tensor] = 
  ty.atenMethod("_fused_dropout", self.tensor, p, generator).to(StdTuple2[ATensor, ATensor]).toNimTuple().newTensors()

proc fused_dropout_internal*(self: Tensor; p: float64; generator: Generator = nil): tuple[result0: Tensor, result1: Tensor] = 
...
proc dropout_inplace*(ty: TensorType; self: Tensor; p: float64; train: bool): Tensor = 
  ty.atenMethod("dropout_", self.tensor, p, train).to(ATensor).newTensor()

proc dropout_inplace*(self: Tensor; p: float64; train: bool): Tensor = 
  atenFunction("at::dropout_", self.tensor, p, train).to(ATensor).newTensor()
...
proc feature_dropout_inplace*(ty: TensorType; self: Tensor; p: float64; train: bool): Tensor = 
  ty.atenMethod("feature_dropout_", self.tensor, p, train).to(ATensor).newTensor()

proc feature_dropout_inplace*(self: Tensor; p: float64; train: bool): Tensor = 
  atenFunction("at::feature_dropout_", self.tensor, p, train).to(ATensor).newTensor()
...
proc alpha_dropout_inplace*(ty: TensorType; self: Tensor; p: float64; train: bool): Tensor = 
  ty.atenMethod("alpha_dropout_", self.tensor, p, train).to(ATensor).newTensor()

proc alpha_dropout_inplace*(self: Tensor; p: float64; train: bool): Tensor = 
  atenFunction("at::alpha_dropout_", self.tensor, p, train).to(ATensor).newTensor()
...
proc feature_alpha_dropout_inplace*(ty: TensorType; self: Tensor; p: float64; train: bool): Tensor = 
  ty.atenMethod("feature_alpha_dropout_", self.tensor, p, train).to(ATensor).newTensor()

proc feature_alpha_dropout_inplace*(self: Tensor; p: float64; train: bool): Tensor = 
  atenFunction("at::feature_alpha_dropout_", self.tensor, p, train).to(ATensor).newTensor()
...
proc abs_inplace*(ty: TensorType; self: Tensor): Tensor = 
  ty.atenMethod("abs_", self.tensor).to(ATensor).newTensor()

proc abs_inplace*(self: Tensor): Tensor = 
  self.tensor.atenMethod("abs_").to(ATensor).newTensor()
...
proc acos_inplace*(ty: TensorType; self: Tensor): Tensor = 
  ty.atenMethod("acos_", self.tensor).to(ATensor).newTensor()

proc acos_inplace*(self: Tensor): Tensor = 
  self.tensor.atenMethod("acos_").to(ATensor).newTensor()
...
proc add_inplace*(ty: TensorType; self: Tensor; other: Tensor; alpha: float = 1): Tensor = 
  ty.atenMethod("add_", self.tensor, other.tensor, alpha).to(ATensor).newTensor()

proc add_inplace*(self: Tensor; other: Tensor; alpha: float = 1): Tensor = 
  self.tensor.atenMethod("add_", other.tensor, alpha).to(ATensor).newTensor()
...
proc add_inplace*(ty: TensorType; self: Tensor; other: float; alpha: float = 1): Tensor = 
  ty.atenMethod("add_", self.tensor, other, alpha).to(ATensor).newTensor()

proc add_inplace*(self: Tensor; other: float; alpha: float = 1): Tensor = 
  self.tensor.atenMethod("add_", other, alpha).to(ATensor).newTensor()
...
proc addmv_inplace*(ty: TensorType; self: Tensor; mat: Tensor; vec: Tensor; beta: float = 1; alpha: float = 1): Tensor = 
  ty.atenMethod("addmv_", self.tensor, mat.tensor, vec.tensor, beta, alpha).to(ATensor).newTensor()

proc addmv_inplace*(self: Tensor; mat: Tensor; vec: Tensor; beta: float = 1; alpha: float = 1): Tensor = 
  self.tensor.atenMethod("addmv_", mat.tensor, vec.tensor, beta, alpha).to(ATensor).newTensor()
...
proc addr_inplace*(ty: TensorType; self: Tensor; vec1: Tensor; vec2: Tensor; beta: float = 1; alpha: float = 1): Tensor = 
  ty.atenMethod("addr_", self.tensor, vec1.tensor, vec2.tensor, beta, alpha).to(ATensor).newTensor()

proc addr_inplace*(self: Tensor; vec1: Tensor; vec2: Tensor; beta: float = 1; alpha: float = 1): Tensor = 
  self.tensor.atenMethod("addr_", vec1.tensor, vec2.tensor, beta, alpha).to(ATensor).newTensor()
...
proc as_strided_inplace*(ty: TensorType; self: Tensor; size: openarray[SomeInteger]; stride: openarray[SomeInteger]): Tensor = 
  ty.atenMethod("as_strided_", self.tensor, size.toAIntList(), stride.toAIntList()).to(ATensor).newTensor()

proc as_strided_inplace*(self: Tensor; size: openarray[SomeInteger]; stride: openarray[SomeInteger]): Tensor = 
  self.tensor.atenMethod("as_strided_", size.toAIntList(), stride.toAIntList()).to(ATensor).newTensor()
...
proc as_strided_inplace*(ty: TensorType; self: Tensor; size: openarray[SomeInteger]; stride: openarray[SomeInteger]; storage_offset: int64): Tensor = 
  ty.atenMethod("as_strided_", self.tensor, size.toAIntList(), stride.toAIntList(), storage_offset).to(ATensor).newTensor()

proc as_strided_inplace*(self: Tensor; size: openarray[SomeInteger]; stride: openarray[SomeInteger]; storage_offset: int64): Tensor = 
  self.tensor.atenMethod("as_strided_", size.toAIntList(), stride.toAIntList(), storage_offset).to(ATensor).newTensor()
...
proc asin_inplace*(ty: TensorType; self: Tensor): Tensor = 
  ty.atenMethod("asin_", self.tensor).to(ATensor).newTensor()

proc asin_inplace*(self: Tensor): Tensor = 
  self.tensor.atenMethod("asin_").to(ATensor).newTensor()
...
proc atan_inplace*(ty: TensorType; self: Tensor): Tensor = 
  ty.atenMethod("atan_", self.tensor).to(ATensor).newTensor()

proc atan_inplace*(self: Tensor): Tensor = 
  self.tensor.atenMethod("atan_").to(ATensor).newTensor()
...
proc bernoulli*(ty: TensorType; self: Tensor; p: Tensor; generator: Generator = nil): Tensor = 
  ty.atenMethod("bernoulli", self.tensor, p.tensor, generator).to(ATensor).newTensor()

proc bernoulli*(self: Tensor; p: Tensor; generator: Generator = nil): Tensor = 
  self.tensor.atenMethod("bernoulli", p.tensor, generator).to(ATensor).newTensor()

proc bernoulli*(ty: TensorType; self: Tensor; p: float64; generator: Generator = nil): Tensor

proc bernoulli*(self: Tensor; p: float64; generator: Generator = nil): Tensor
...
proc bernoulli_inplace*(ty: TensorType; self: Tensor; p: Tensor; generator: Generator = nil): Tensor = 
  ty.atenMethod("bernoulli_", self.tensor, p.tensor, generator).to(ATensor).newTensor()

proc bernoulli_inplace*(self: Tensor; p: Tensor; generator: Generator = nil): Tensor = 
  self.tensor.atenMethod("bernoulli_", p.tensor, generator).to(ATensor).newTensor()

proc bernoulli_inplace*(ty: TensorType; self: Tensor; p: float64; generator: Generator = nil): Tensor = 
  ty.atenMethod("bernoulli_", self.tensor, p, generator).to(ATensor).newTensor()

proc bernoulli_inplace*(self: Tensor; p: float64; generator: Generator = nil): Tensor = 
  self.tensor.atenMethod("bernoulli_", p, generator).to(ATensor).newTensor()

proc bernoulli_inplace*(ty: TensorType; self: Tensor): Tensor = 
  ty.atenMethod("bernoulli_", self.tensor).to(ATensor).newTensor()

proc bernoulli_inplace*(self: Tensor): Tensor = 
  self.tensor.atenMethod("bernoulli_").to(ATensor).newTensor()
...
proc broadcast_tensors*(ty: TensorType; tensors: openarray[Tensor]): TensorList = 
  ty.atenMethod("broadcast_tensors", tensors.toATensors()).to(ATensors).newTensors()

proc broadcast_tensors*(tensors: openarray[Tensor]): TensorList = 
  atenFunction("at::broadcast_tensors", tensors.toATensors()).to(ATensors).newTensors()

proc cat*(ty: TensorType; tensors: openarray[Tensor]; dim: int64 = 0): Tensor

proc cat*(tensors: openarray[Tensor]; dim: int64 = 0): Tensor
...
proc ceil_inplace*(ty: TensorType; self: Tensor): Tensor = 
  ty.atenMethod("ceil_", self.tensor).to(ATensor).newTensor()

proc ceil_inplace*(self: Tensor): Tensor = 
  self.tensor.atenMethod("ceil_").to(ATensor).newTensor()
...
proc clamp_inplace*(ty: TensorType; self: Tensor; min: float; max: float): Tensor = 
  ty.atenMethod("clamp_", self.tensor, min, max).to(ATensor).newTensor()

proc clamp_inplace*(self: Tensor; min: float; max: float): Tensor = 
  self.tensor.atenMethod("clamp_", min, max).to(ATensor).newTensor()
...
proc clamp_max_inplace*(ty: TensorType; self: Tensor; max: float): Tensor = 
  ty.atenMethod("clamp_max_", self.tensor, max).to(ATensor).newTensor()

proc clamp_max_inplace*(self: Tensor; max: float): Tensor = 
  self.tensor.atenMethod("clamp_max_", max).to(ATensor).newTensor()
...
proc clamp_min_inplace*(ty: TensorType; self: Tensor; min: float): Tensor = 
  ty.atenMethod("clamp_min_", self.tensor, min).to(ATensor).newTensor()

proc clamp_min_inplace*(self: Tensor; min: float): Tensor = 
  self.tensor.atenMethod("clamp_min_", min).to(ATensor).newTensor()
...
proc cos_inplace*(ty: TensorType; self: Tensor): Tensor = 
  ty.atenMethod("cos_", self.tensor).to(ATensor).newTensor()

proc cos_inplace*(self: Tensor): Tensor = 
  self.tensor.atenMethod("cos_").to(ATensor).newTensor()
...
proc cosh_inplace*(ty: TensorType; self: Tensor): Tensor = 
  ty.atenMethod("cosh_", self.tensor).to(ATensor).newTensor()

proc cosh_inplace*(self: Tensor): Tensor = 
  self.tensor.atenMethod("cosh_").to(ATensor).newTensor()
...
proc div_inplace*(ty: TensorType; self: Tensor; other: Tensor): Tensor = 
  ty.atenMethod("div_", self.tensor, other.tensor).to(ATensor).newTensor()

proc div_inplace*(self: Tensor; other: Tensor): Tensor = 
  self.tensor.atenMethod("div_", other.tensor).to(ATensor).newTensor()
...
proc div_inplace*(ty: TensorType; self: Tensor; other: float): Tensor = 
  ty.atenMethod("div_", self.tensor, other).to(ATensor).newTensor()

proc div_inplace*(self: Tensor; other: float): Tensor = 
  self.tensor.atenMethod("div_", other).to(ATensor).newTensor()

proc dot*(ty: TensorType; self: Tensor; tensor: Tensor): Tensor

proc dot*(self: Tensor; tensor: Tensor): Tensor

proc einsum*(ty: TensorType; equation: StdString; tensors: openarray[Tensor]): Tensor = 
  ty.atenMethod("einsum", equation, tensors.toATensors()).to(ATensor).newTensor()

proc einsum*(equation: StdString; tensors: openarray[Tensor]): Tensor = 
...
proc embedding_renorm_inplace*(ty: TensorType; self: Tensor; indices: Tensor; max_norm: float64; norm_type: float64): Tensor = 
  ty.atenMethod("embedding_renorm_", self.tensor, indices.tensor, max_norm, norm_type).to(ATensor).newTensor()

proc embedding_renorm_inplace*(self: Tensor; indices: Tensor; max_norm: float64; norm_type: float64): Tensor = 
  atenFunction("at::embedding_renorm_", self.tensor, indices.tensor, max_norm, norm_type).to(ATensor).newTensor()
...
proc erf_inplace*(ty: TensorType; self: Tensor): Tensor = 
  ty.atenMethod("erf_", self.tensor).to(ATensor).newTensor()

proc erf_inplace*(self: Tensor): Tensor = 
  self.tensor.atenMethod("erf_").to(ATensor).newTensor()
...
proc erfc_inplace*(ty: TensorType; self: Tensor): Tensor = 
  ty.atenMethod("erfc_", self.tensor).to(ATensor).newTensor()

proc erfc_inplace*(self: Tensor): Tensor = 
  self.tensor.atenMethod("erfc_").to(ATensor).newTensor()
...
proc exp_inplace*(ty: TensorType; self: Tensor): Tensor = 
  ty.atenMethod("exp_", self.tensor).to(ATensor).newTensor()

proc exp_inplace*(self: Tensor): Tensor = 
  self.tensor.atenMethod("exp_").to(ATensor).newTensor()
...
proc expm1_inplace*(ty: TensorType; self: Tensor): Tensor = 
  ty.atenMethod("expm1_", self.tensor).to(ATensor).newTensor()

proc expm1_inplace*(self: Tensor): Tensor = 
  self.tensor.atenMethod("expm1_").to(ATensor).newTensor()
...
proc floor_inplace*(ty: TensorType; self: Tensor): Tensor = 
  ty.atenMethod("floor_", self.tensor).to(ATensor).newTensor()

proc floor_inplace*(self: Tensor): Tensor = 
  self.tensor.atenMethod("floor_").to(ATensor).newTensor()
...
proc index*(ty: TensorType; self: Tensor; indices: openarray[Tensor]): Tensor = 
  ty.atenMethod("index", self.tensor, indices.toATensors()).to(ATensor).newTensor()

proc index*(self: Tensor; indices: openarray[Tensor]): Tensor = 
...
proc index_put*(ty: TensorType; self: Tensor; indices: openarray[Tensor]; values: Tensor): Tensor = 
  ty.atenMethod("index_put", self.tensor, indices.toATensors(), values.tensor).to(ATensor).newTensor()

proc index_put*(self: Tensor; indices: openarray[Tensor]; values: Tensor): Tensor = 
  self.tensor.atenMethod("index_put", indices.toATensors(), values.tensor).to(ATensor).newTensor()

proc index_put_inplace*(ty: TensorType; self: Tensor; indices: openarray[Tensor]; values: Tensor): Tensor = 
  ty.atenMethod("index_put_", self.tensor, indices.toATensors(), values.tensor).to(ATensor).newTensor()

proc index_put_inplace*(self: Tensor; indices: openarray[Tensor]; values: Tensor): Tensor = 
  self.tensor.atenMethod("index_put_", indices.toATensors(), values.tensor).to(ATensor).newTensor()
...
proc log_inplace*(ty: TensorType; self: Tensor): Tensor = 
  ty.atenMethod("log_", self.tensor).to(ATensor).newTensor()

proc log_inplace*(self: Tensor): Tensor = 
  self.tensor.atenMethod("log_").to(ATensor).newTensor()
...
proc log10_inplace*(ty: TensorType; self: Tensor): Tensor = 
  ty.atenMethod("log10_", self.tensor).to(ATensor).newTensor()

proc log10_inplace*(self: Tensor): Tensor = 
  self.tensor.atenMethod("log10_").to(ATensor).newTensor()
...
proc log1p_inplace*(ty: TensorType; self: Tensor): Tensor = 
  ty.atenMethod("log1p_", self.tensor).to(ATensor).newTensor()

proc log1p_inplace*(self: Tensor): Tensor = 
  self.tensor.atenMethod("log1p_").to(ATensor).newTensor()
...
proc log2_inplace*(ty: TensorType; self: Tensor): Tensor = 
  ty.atenMethod("log2_", self.tensor).to(ATensor).newTensor()

proc log2_inplace*(self: Tensor): Tensor = 
  self.tensor.atenMethod("log2_").to(ATensor).newTensor()
...
proc mul_inplace*(ty: TensorType; self: Tensor; other: Tensor): Tensor = 
  ty.atenMethod("mul_", self.tensor, other.tensor).to(ATensor).newTensor()

proc mul_inplace*(self: Tensor; other: Tensor): Tensor = 
  self.tensor.atenMethod("mul_", other.tensor).to(ATensor).newTensor()
...
proc mul_inplace*(ty: TensorType; self: Tensor; other: float): Tensor = 
  ty.atenMethod("mul_", self.tensor, other).to(ATensor).newTensor()

proc mul_inplace*(self: Tensor; other: float): Tensor = 
  self.tensor.atenMethod("mul_", other).to(ATensor).newTensor()
...
proc mvlgamma_inplace*(ty: TensorType; self: Tensor; p: int64): Tensor = 
  ty.atenMethod("mvlgamma_", self.tensor, p).to(ATensor).newTensor()

proc mvlgamma_inplace*(self: Tensor; p: int64): Tensor = 
  self.tensor.atenMethod("mvlgamma_", p).to(ATensor).newTensor()
...
proc rand*(ty: TensorType; size: openarray[SomeInteger]; generator: Generator; options: TensorOptions): Tensor = 
  ty.atenMethod("rand", size.toAIntList(), generator, options).to(ATensor).newTensor()

proc rand*(size: openarray[SomeInteger]; generator: Generator; options: TensorOptions): Tensor = 
...
proc randint*(ty: TensorType; high: int64; size: openarray[SomeInteger]; generator: Generator; options: TensorOptions): Tensor = 
  ty.atenMethod("randint", high, size.toAIntList(), generator, options).to(ATensor).newTensor()

proc randint*(high: int64; size: openarray[SomeInteger]; generator: Generator; options: TensorOptions): Tensor = 
...
proc randint*(ty: TensorType; low: int64; high: int64; size: openarray[SomeInteger]; generator: Generator; options: TensorOptions): Tensor = 
  ty.atenMethod("randint", low, high, size.toAIntList(), generator, options).to(ATensor).newTensor()

proc randint*(low: int64; high: int64; size: openarray[SomeInteger]; generator: Generator; options: TensorOptions): Tensor = 
...
proc randn*(ty: TensorType; size: openarray[SomeInteger]; generator: Generator; options: TensorOptions): Tensor = 
  ty.atenMethod("randn", size.toAIntList(), generator, options).to(ATensor).newTensor()

proc randn*(size: openarray[SomeInteger]; generator: Generator; options: TensorOptions): Tensor = 
...
proc randperm*(ty: TensorType; n: int64; generator: Generator; options: TensorOptions): Tensor = 
  ty.atenMethod("randperm", n, generator, options).to(ATensor).newTensor()

proc randperm*(n: int64; generator: Generator; options: TensorOptions): Tensor = 
...
proc round_inplace*(ty: TensorType; self: Tensor): Tensor = 
  ty.atenMethod("round_", self.tensor).to(ATensor).newTensor()

proc round_inplace*(self: Tensor): Tensor = 
  self.tensor.atenMethod("round_").to(ATensor).newTensor()

proc rrelu*(ty: TensorType; self: Tensor; lower: float; upper: float; training: bool = false; generator: Generator = nil): Tensor = 
  ty.atenMethod("rrelu", self.tensor, lower, upper, training, generator).to(ATensor).newTensor()

proc rrelu*(self: Tensor; lower: float; upper: float; training: bool = false; generator: Generator = nil): Tensor = 
  atenFunction("at::rrelu", self.tensor, lower, upper, training, generator).to(ATensor).newTensor()

proc rrelu_inplace*(ty: TensorType; self: Tensor; lower: float; upper: float; training: bool = false; generator: Generator = nil): Tensor = 
  ty.atenMethod("rrelu_", self.tensor, lower, upper, training, generator).to(ATensor).newTensor()

proc rrelu_inplace*(self: Tensor; lower: float; upper: float; training: bool = false; generator: Generator = nil): Tensor = 
  atenFunction("at::rrelu_", self.tensor, lower, upper, training, generator).to(ATensor).newTensor()
...
proc relu_inplace*(ty: TensorType; self: Tensor): Tensor = 
  ty.atenMethod("relu_", self.tensor).to(ATensor).newTensor()

proc relu_inplace*(self: Tensor): Tensor = 
  self.tensor.atenMethod("relu_").to(ATensor).newTensor()
...
proc rsqrt_inplace*(ty: TensorType; self: Tensor): Tensor = 
  ty.atenMethod("rsqrt_", self.tensor).to(ATensor).newTensor()

proc rsqrt_inplace*(self: Tensor): Tensor = 
  self.tensor.atenMethod("rsqrt_").to(ATensor).newTensor()
...
proc selu_inplace*(ty: TensorType; self: Tensor): Tensor = 
  ty.atenMethod("selu_", self.tensor).to(ATensor).newTensor()

proc selu_inplace*(self: Tensor): Tensor = 
  atenFunction("at::selu_", self.tensor).to(ATensor).newTensor()
...
proc celu_inplace*(ty: TensorType; self: Tensor; alpha: float): Tensor = 
  ty.atenMethod("celu_", self.tensor, alpha).to(ATensor).newTensor()

proc celu_inplace*(self: Tensor; alpha: float): Tensor = 
  atenFunction("at::celu_", self.tensor, alpha).to(ATensor).newTensor()
...
proc sigmoid_inplace*(ty: TensorType; self: Tensor): Tensor = 
  ty.atenMethod("sigmoid_", self.tensor).to(ATensor).newTensor()

proc sigmoid_inplace*(self: Tensor): Tensor = 
  self.tensor.atenMethod("sigmoid_").to(ATensor).newTensor()
...
proc sin_inplace*(ty: TensorType; self: Tensor): Tensor = 
  ty.atenMethod("sin_", self.tensor).to(ATensor).newTensor()

proc sin_inplace*(self: Tensor): Tensor = 
  self.tensor.atenMethod("sin_").to(ATensor).newTensor()
...
proc sinh_inplace*(ty: TensorType; self: Tensor): Tensor = 
  ty.atenMethod("sinh_", self.tensor).to(ATensor).newTensor()

proc sinh_inplace*(self: Tensor): Tensor = 
  self.tensor.atenMethod("sinh_").to(ATensor).newTensor()
...
proc stack*(ty: TensorType; tensors: openarray[Tensor]; dim: int64 = 0): Tensor

proc stack*(tensors: openarray[Tensor]; dim: int64 = 0): Tensor
...
proc sqrt_inplace*(ty: TensorType; self: Tensor): Tensor = 
  ty.atenMethod("sqrt_", self.tensor).to(ATensor).newTensor()

proc sqrt_inplace*(self: Tensor): Tensor = 
  self.tensor.atenMethod("sqrt_").to(ATensor).newTensor()
...
proc t_inplace*(ty: TensorType; self: Tensor): Tensor = 
  ty.atenMethod("t_", self.tensor).to(ATensor).newTensor()

proc t_inplace*(self: Tensor): Tensor = 
  self.tensor.atenMethod("t_").to(ATensor).newTensor()
...
proc tan_inplace*(ty: TensorType; self: Tensor): Tensor = 
  ty.atenMethod("tan_", self.tensor).to(ATensor).newTensor()

proc tan_inplace*(self: Tensor): Tensor = 
  self.tensor.atenMethod("tan_").to(ATensor).newTensor()
...
proc tanh_inplace*(ty: TensorType; self: Tensor): Tensor = 
  ty.atenMethod("tanh_", self.tensor).to(ATensor).newTensor()

proc tanh_inplace*(self: Tensor): Tensor = 
  self.tensor.atenMethod("tanh_").to(ATensor).newTensor()
...
proc trunc_inplace*(ty: TensorType; self: Tensor): Tensor = 
  ty.atenMethod("trunc_", self.tensor).to(ATensor).newTensor()

proc trunc_inplace*(self: Tensor): Tensor = 
  self.tensor.atenMethod("trunc_").to(ATensor).newTensor()
...
proc standard_gamma_internal*(ty: TensorType; self: Tensor; generator: Generator = nil): Tensor

proc standard_gamma_internal*(self: Tensor; generator: Generator = nil): Tensor

proc poisson*(ty: TensorType; self: Tensor; generator: Generator = nil): Tensor

proc poisson*(self: Tensor; generator: Generator = nil): Tensor
...
proc native_resize_as_inplace*(ty: TensorType; self: Tensor; the_template: Tensor): Tensor = 
  ty.atenMethod("native_resize_as_", self.tensor, the_template.tensor).to(ATensor).newTensor()

proc native_resize_as_inplace*(self: Tensor; the_template: Tensor): Tensor = 
  atenFunction("at::native_resize_as_", self.tensor, the_template.tensor).to(ATensor).newTensor()

proc resize_as_inplace*(ty: TensorType; self: Tensor; the_template: Tensor): Tensor = 
  ty.atenMethod("resize_as_", self.tensor, the_template.tensor).to(ATensor).newTensor()

proc resize_as_inplace*(self: Tensor; the_template: Tensor): Tensor = 
  self.tensor.atenMethod("resize_as_", the_template.tensor).to(ATensor).newTensor()
...
proc native_zero_inplace*(ty: TensorType; self: Tensor): Tensor = 
  ty.atenMethod("native_zero_", self.tensor).to(ATensor).newTensor()

proc native_zero_inplace*(self: Tensor): Tensor = 
  atenFunction("at::native_zero_", self.tensor).to(ATensor).newTensor()
...
proc sub_inplace*(ty: TensorType; self: Tensor; other: Tensor; alpha: float = 1): Tensor = 
  ty.atenMethod("sub_", self.tensor, other.tensor, alpha).to(ATensor).newTensor()

proc sub_inplace*(self: Tensor; other: Tensor; alpha: float = 1): Tensor = 
  self.tensor.atenMethod("sub_", other.tensor, alpha).to(ATensor).newTensor()
...
proc sub_inplace*(ty: TensorType; self: Tensor; other: float; alpha: float = 1): Tensor = 
  ty.atenMethod("sub_", self.tensor, other, alpha).to(ATensor).newTensor()

proc sub_inplace*(self: Tensor; other: float; alpha: float = 1): Tensor = 
  self.tensor.atenMethod("sub_", other, alpha).to(ATensor).newTensor()
...
proc s_native_addmm_inplace*(ty: TensorType; self: Tensor; mat1: Tensor; mat2: Tensor; beta: float = 1; alpha: float = 1): Tensor = 
  ty.atenMethod("s_native_addmm_", self.tensor, mat1.tensor, mat2.tensor, beta, alpha).to(ATensor).newTensor()

proc s_native_addmm_inplace*(self: Tensor; mat1: Tensor; mat2: Tensor; beta: float = 1; alpha: float = 1): Tensor = 
  atenFunction("at::s_native_addmm_", self.tensor, mat1.tensor, mat2.tensor, beta, alpha).to(ATensor).newTensor()
...
proc addmm_inplace*(ty: TensorType; self: Tensor; mat1: Tensor; mat2: Tensor; beta: float = 1; alpha: float = 1): Tensor = 
  ty.atenMethod("addmm_", self.tensor, mat1.tensor, mat2.tensor, beta, alpha).to(ATensor).newTensor()

proc addmm_inplace*(self: Tensor; mat1: Tensor; mat2: Tensor; beta: float = 1; alpha: float = 1): Tensor = 
  self.tensor.atenMethod("addmm_", mat1.tensor, mat2.tensor, beta, alpha).to(ATensor).newTensor()
...
proc sparse_raw_resize_inplace*(ty: TensorType; self: Tensor; size: openarray[SomeInteger]; sparseDims: int64; denseDims: int64): Tensor = 
  ty.atenMethod("sparse_raw_resize_", self.tensor, size.toAIntList(), sparseDims, denseDims).to(ATensor).newTensor()

proc sparse_raw_resize_inplace*(self: Tensor; size: openarray[SomeInteger]; sparseDims: int64; denseDims: int64): Tensor = 
  self.tensor.atenMethod("sparse_raw_resize_", size.toAIntList(), sparseDims, denseDims).to(ATensor).newTensor()
...
proc raw_copy_sparse_inplace*(ty: TensorType; self: Tensor; src: Tensor): Tensor = 
  ty.atenMethod("raw_copy_sparse_", self.tensor, src.tensor).to(ATensor).newTensor()

proc raw_copy_sparse_inplace*(self: Tensor; src: Tensor): Tensor = 
  atenFunction("at::raw_copy_sparse_", self.tensor, src.tensor).to(ATensor).newTensor()
...
proc meshgrid*(ty: TensorType; tensors: openarray[Tensor]): TensorList = 
  ty.atenMethod("meshgrid", tensors.toATensors()).to(ATensors).newTensors()

proc meshgrid*(tensors: openarray[Tensor]): TensorList = 
...
proc lstm*(ty: TensorType; input: Tensor; hx: openarray[Tensor]; params: openarray[Tensor]; has_biases: bool; num_layers: int64; dropout: float64; train: bool; bidirectional: bool; batch_first: bool): tuple[result0: Tensor, result1: Tensor, result2: Tensor] = 
...
proc lstm*(input: Tensor; hx: openarray[Tensor]; params: openarray[Tensor]; has_biases: bool; num_layers: int64; dropout: float64; train: bool; bidirectional: bool; batch_first: bool): tuple[result0: Tensor, result1: Tensor, result2: Tensor] = 
...
proc lstm*(ty: TensorType; data: Tensor; batch_sizes: Tensor; hx: openarray[Tensor]; params: openarray[Tensor]; has_biases: bool; num_layers: int64; dropout: float64; train: bool; bidirectional: bool): tuple[result0: Tensor, result1: Tensor, result2: Tensor] = 
...
proc lstm*(data: Tensor; batch_sizes: Tensor; hx: openarray[Tensor]; params: openarray[Tensor]; has_biases: bool; num_layers: int64; dropout: float64; train: bool; bidirectional: bool): tuple[result0: Tensor, result1: Tensor, result2: Tensor] = 
...
proc gru*(ty: TensorType; input: Tensor; hx: Tensor; params: openarray[Tensor]; has_biases: bool; num_layers: int64; dropout: float64; train: bool; bidirectional: bool; batch_first: bool): tuple[result0: Tensor, result1: Tensor] = 
...
proc gru*(input: Tensor; hx: Tensor; params: openarray[Tensor]; has_biases: bool; num_layers: int64; dropout: float64; train: bool; bidirectional: bool; batch_first: bool): tuple[result0: Tensor, result1: Tensor] = 
...
proc gru*(ty: TensorType; data: Tensor; batch_sizes: Tensor; hx: Tensor; params: openarray[Tensor]; has_biases: bool; num_layers: int64; dropout: float64; train: bool; bidirectional: bool): tuple[result0: Tensor, result1: Tensor] = 
...
proc gru*(data: Tensor; batch_sizes: Tensor; hx: Tensor; params: openarray[Tensor]; has_biases: bool; num_layers: int64; dropout: float64; train: bool; bidirectional: bool): tuple[result0: Tensor, result1: Tensor] = 
...
proc rnn_tanh*(ty: TensorType; input: Tensor; hx: Tensor; params: openarray[Tensor]; has_biases: bool; num_layers: int64; dropout: float64; train: bool; bidirectional: bool; batch_first: bool): tuple[result0: Tensor, result1: Tensor] = 
...
proc rnn_tanh*(input: Tensor; hx: Tensor; params: openarray[Tensor]; has_biases: bool; num_layers: int64; dropout: float64; train: bool; bidirectional: bool; batch_first: bool): tuple[result0: Tensor, result1: Tensor] = 
...
proc rnn_tanh*(ty: TensorType; data: Tensor; batch_sizes: Tensor; hx: Tensor; params: openarray[Tensor]; has_biases: bool; num_layers: int64; dropout: float64; train: bool; bidirectional: bool): tuple[result0: Tensor, result1: Tensor] = 
...
proc rnn_tanh*(data: Tensor; batch_sizes: Tensor; hx: Tensor; params: openarray[Tensor]; has_biases: bool; num_layers: int64; dropout: float64; train: bool; bidirectional: bool): tuple[result0: Tensor, result1: Tensor] = 
...
proc rnn_relu*(ty: TensorType; input: Tensor; hx: Tensor; params: openarray[Tensor]; has_biases: bool; num_layers: int64; dropout: float64; train: bool; bidirectional: bool; batch_first: bool): tuple[result0: Tensor, result1: Tensor] = 
...
proc rnn_relu*(input: Tensor; hx: Tensor; params: openarray[Tensor]; has_biases: bool; num_layers: int64; dropout: float64; train: bool; bidirectional: bool; batch_first: bool): tuple[result0: Tensor, result1: Tensor] = 
...
proc rnn_relu*(ty: TensorType; data: Tensor; batch_sizes: Tensor; hx: Tensor; params: openarray[Tensor]; has_biases: bool; num_layers: int64; dropout: float64; train: bool; bidirectional: bool): tuple[result0: Tensor, result1: Tensor] = 
...
proc rnn_relu*(data: Tensor; batch_sizes: Tensor; hx: Tensor; params: openarray[Tensor]; has_biases: bool; num_layers: int64; dropout: float64; train: bool; bidirectional: bool): tuple[result0: Tensor, result1: Tensor] = 
...
proc lstm_cell*(ty: TensorType; input: Tensor; hx: openarray[Tensor]; w_ih: Tensor; w_hh: Tensor; b_ih: Tensor; b_hh: Tensor): tuple[result0: Tensor, result1: Tensor] = 
...
proc lstm_cell*(input: Tensor; hx: openarray[Tensor]; w_ih: Tensor; w_hh: Tensor; b_ih: Tensor; b_hh: Tensor): tuple[result0: Tensor, result1: Tensor] = 
