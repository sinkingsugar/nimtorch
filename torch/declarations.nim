...
template thnn_grid_sampler_bilinear2d_backward_out*(grad_input: Tensor, grad_grid: Tensor, grad_output: Tensor, self: Tensor, grid: Tensor, padding_mode: int64): (Tensor, Tensor) = dynamicCCall("at::thnn_grid_sampler_bilinear2d_backward_out", grad_input, grad_grid, grad_output, self, grid, padding_mode).to(ATensorRTuple2).toNimTensorTuple()
template thnn_grid_sampler_bilinear2d_backward*(grad_output: Tensor, self: Tensor, grid: Tensor, padding_mode: int64): (Tensor, Tensor) = dynamicCCall("at::thnn_grid_sampler_bilinear2d_backward", grad_output, self, grid, padding_mode).to(ATensorTuple2).toNimTensorTuple()
...
template thnn_grid_sampler_bilinear3d_backward_out*(grad_input: Tensor, grad_grid: Tensor, grad_output: Tensor, self: Tensor, grid: Tensor, padding_mode: int64): (Tensor, Tensor) = dynamicCCall("at::thnn_grid_sampler_bilinear3d_backward_out", grad_input, grad_grid, grad_output, self, grid, padding_mode).to(ATensorRTuple2).toNimTensorTuple()
template thnn_grid_sampler_bilinear3d_backward*(grad_output: Tensor, self: Tensor, grid: Tensor, padding_mode: int64): (Tensor, Tensor) = dynamicCCall("at::thnn_grid_sampler_bilinear3d_backward", grad_output, self, grid, padding_mode).to(ATensorTuple2).toNimTensorTuple()
