...
template prelu_backward*(grad_output: Tensor, self: Tensor, weight: Tensor, output_mask: BoolArray2): (Tensor, Tensor) = dynamicCCall("at::prelu_backward", grad_output, self, weight, output_mask).to(ATensorTuple2).toNimTensorTuple()
...
template thnn_batch_norm_backward*(grad_output: Tensor, self: Tensor, weight: Tensor, running_mean: Tensor, running_var: Tensor, training: bool, eps: float64, save_mean: Tensor, save_std: Tensor, output_mask: BoolArray3): (Tensor, Tensor, Tensor) = dynamicCCall("at::thnn_batch_norm_backward", grad_output, self, weight, running_mean, running_var, training, eps, save_mean, save_std, output_mask).to(ATensorTuple3).toNimTensorTuple()
...
template thnn_conv_transpose2d_backward*(grad_output: Tensor, self: Tensor, weight: Tensor, kernel_size: IntList, stride: IntList, padding: IntList, output_padding: IntList, dilation: IntList, columns: Tensor, ones: Tensor, output_mask: BoolArray3): (Tensor, Tensor, Tensor) = dynamicCCall("at::thnn_conv_transpose2d_backward", grad_output, self, weight, kernel_size, stride, padding, output_padding, dilation, columns, ones, output_mask).to(ATensorTuple3).toNimTensorTuple()
...
template thnn_conv_depthwise2d_backward*(grad_output: Tensor, self: Tensor, weight: Tensor, kernel_size: IntList, stride: IntList, padding: IntList, dilation: IntList, output_mask: BoolArray2): (Tensor, Tensor) = dynamicCCall("at::thnn_conv_depthwise2d_backward", grad_output, self, weight, kernel_size, stride, padding, dilation, output_mask).to(ATensorTuple2).toNimTensorTuple()
...
template thnn_conv3d_backward*(grad_output: Tensor, self: Tensor, weight: Tensor, kernel_size: IntList, stride: IntList, padding: IntList, finput: Tensor, fgrad_input: Tensor, output_mask: BoolArray3): (Tensor, Tensor, Tensor) = dynamicCCall("at::thnn_conv3d_backward", grad_output, self, weight, kernel_size, stride, padding, finput, fgrad_input, output_mask).to(ATensorTuple3).toNimTensorTuple()
...
template thnn_conv_dilated2d_backward*(grad_output: Tensor, self: Tensor, weight: Tensor, kernel_size: IntList, stride: IntList, padding: IntList, dilation: IntList, columns: Tensor, ones: Tensor, output_mask: BoolArray3): (Tensor, Tensor, Tensor) = dynamicCCall("at::thnn_conv_dilated2d_backward", grad_output, self, weight, kernel_size, stride, padding, dilation, columns, ones, output_mask).to(ATensorTuple3).toNimTensorTuple()
...
template thnn_conv_dilated3d_backward*(grad_output: Tensor, self: Tensor, weight: Tensor, kernel_size: IntList, stride: IntList, padding: IntList, dilation: IntList, columns: Tensor, ones: Tensor, output_mask: BoolArray3): (Tensor, Tensor, Tensor) = dynamicCCall("at::thnn_conv_dilated3d_backward", grad_output, self, weight, kernel_size, stride, padding, dilation, columns, ones, output_mask).to(ATensorTuple3).toNimTensorTuple()
...
template u_cudnn_rnn_backward*(input: Tensor, weight: TensorList, weight_stride0: int64, weight_buf: Tensor, hx: Tensor, cx: Tensor, output: Tensor, grad_output: Tensor, grad_hy: Tensor, grad_cy: Tensor, mode: int64, hidden_size: int64, num_layers: int64, batch_first: bool, dropout: float64, train: bool, bidirectional: bool, batch_sizes: IntList, dropout_state: Tensor, reserve: Tensor, output_mask: BoolArray4): (Tensor, Tensor, Tensor, TensorList) = dynamicCCall("at::_cudnn_rnn_backward", input, weight, weight_stride0, weight_buf, hx, cx, output, grad_output, grad_hy, grad_cy, mode, hidden_size, num_layers, batch_first, dropout, train, bidirectional, batch_sizes, dropout_state, reserve, output_mask).to(ATensorTuple3v1).toNimTensorTuple()
...
template u_convolution_double_backward*(ggI: Tensor, ggW: Tensor, ggb: Tensor, gO: Tensor, weight: Tensor, self: Tensor, stride: IntList, padding: IntList, dilation: IntList, transposed: bool, output_padding: IntList, groups: int64, benchmark: bool, deterministic: bool, cudnn_enabled: bool, output_mask: BoolArray3): (Tensor, Tensor, Tensor) = dynamicCCall("at::_convolution_double_backward", ggI, ggW, ggb, gO, weight, self, stride, padding, dilation, transposed, output_padding, groups, benchmark, deterministic, cudnn_enabled, output_mask).to(ATensorTuple3).toNimTensorTuple()
...
template cudnn_convolution_backward*(self: Tensor, grad_output: Tensor, weight: Tensor, padding: IntList, stride: IntList, dilation: IntList, groups: int64, benchmark: bool, deterministic: bool, output_mask: BoolArray3): (Tensor, Tensor, Tensor) = dynamicCCall("at::cudnn_convolution_backward", self, grad_output, weight, padding, stride, dilation, groups, benchmark, deterministic, output_mask).to(ATensorTuple3).toNimTensorTuple()
...
template cudnn_convolution_transpose_backward*(self: Tensor, grad_output: Tensor, weight: Tensor, padding: IntList, output_padding: IntList, stride: IntList, dilation: IntList, groups: int64, benchmark: bool, deterministic: bool, output_mask: BoolArray3): (Tensor, Tensor, Tensor) = dynamicCCall("at::cudnn_convolution_transpose_backward", self, grad_output, weight, padding, output_padding, stride, dilation, groups, benchmark, deterministic, output_mask).to(ATensorTuple3).toNimTensorTuple()
...
template mkldnn_convolution_backward*(self: Tensor, grad_output: Tensor, weight: Tensor, padding: IntList, stride: IntList, dilation: IntList, groups: int64, output_mask: BoolArray3): (Tensor, Tensor, Tensor) = dynamicCCall("at::mkldnn_convolution_backward", self, grad_output, weight, padding, stride, dilation, groups, output_mask).to(ATensorTuple3).toNimTensorTuple()
...
template u_sparse_dense_add_out*(aresult: Tensor, self: Tensor, other: SparseTensorRef, alpha: float = 1): Tensor = dynamicCCall("at::_sparse_dense_add_out", aresult, self, other, alpha).to(Tensor)
...
template u_sparse_mask*(self: Tensor, mask: SparseTensorRef): Tensor = self.dynamicCppCall("_sparse_mask", mask).to(Tensor)
