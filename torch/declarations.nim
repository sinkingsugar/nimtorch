...
template u_cudnn_ctc_loss*(log_probs: Tensor, targets: Tensor, input_lengths: IntList, target_lengths: IntList, blank: int64, deterministic: bool): (Tensor, Tensor) = dynamicCCall("at::_cudnn_ctc_loss", log_probs, targets, input_lengths, target_lengths, blank, deterministic).to(StdTuple2[Tensor, Tensor]).toNimTuple()
...
template u_ctc_loss*(log_probs: Tensor, targets: Tensor, input_lengths: IntList, target_lengths: IntList, blank: int64 = 0): (Tensor, Tensor) = dynamicCCall("at::_ctc_loss", log_probs, targets, input_lengths, target_lengths, blank).to(StdTuple2[Tensor, Tensor]).toNimTuple()
...
template grid_sampler_2d_backward*(grad_output: Tensor, input: Tensor, grid: Tensor, interpolation_mode: int64, padding_mode: int64): (Tensor, Tensor) = dynamicCCall("at::grid_sampler_2d_backward", grad_output, input, grid, interpolation_mode, padding_mode).to(StdTuple2[Tensor, Tensor]).toNimTuple()
...
template grid_sampler_3d_backward*(grad_output: Tensor, input: Tensor, grid: Tensor, interpolation_mode: int64, padding_mode: int64): (Tensor, Tensor) = dynamicCCall("at::grid_sampler_3d_backward", grad_output, input, grid, interpolation_mode, padding_mode).to(StdTuple2[Tensor, Tensor]).toNimTuple()
