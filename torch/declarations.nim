...
proc resize_u*(self: Tensor, size: IntList): Tensor {.inline.} = self.dynamicCppCall("resize_", size).to(Tensor)
...
proc view*(self: Tensor, size: IntList): Tensor {.inline.} = self.dynamicCppCall("view", size).to(Tensor)
...
proc random_u*(self: Tensor, afrom: int64, ato: int64, generator: pointer = nil): Tensor {.inline.} = self.dynamicCppCall("random_", afrom, ato, generator).to(Tensor)
proc random_u*(self: Tensor, ato: int64, generator: pointer = nil): Tensor {.inline.} = self.dynamicCppCall("random_", ato, generator).to(Tensor)
proc random_u*(self: Tensor, generator: pointer = nil): Tensor {.inline.} = self.dynamicCppCall("random_", generator).to(Tensor)
proc multinomial_out*(aresult: Tensor, self: Tensor, num_samples: int64, replacement: bool = false, generator: pointer = nil): Tensor {.inline.} = dynamicCCall("at::multinomial_out", aresult, self, num_samples, replacement, generator).to(Tensor)
proc multinomial*(self: Tensor, num_samples: int64, replacement: bool = false, generator: pointer = nil): Tensor {.inline.} = self.dynamicCppCall("multinomial", num_samples, replacement, generator).to(Tensor)
proc uniform_u*(self: Tensor, afrom: float64 = 0, ato: float64 = 1, generator: pointer = nil): Tensor {.inline.} = self.dynamicCppCall("uniform_", afrom, ato, generator).to(Tensor)
proc normal_u*(self: Tensor, mean: float64 = 0, std: float64 = 1, generator: pointer = nil): Tensor {.inline.} = self.dynamicCppCall("normal_", mean, std, generator).to(Tensor)
proc cauchy_u*(self: Tensor, median: float64 = 0, sigma: float64 = 1, generator: pointer = nil): Tensor {.inline.} = self.dynamicCppCall("cauchy_", median, sigma, generator).to(Tensor)
proc log_normal_u*(self: Tensor, mean: float64 = 1, std: float64 = 2, generator: pointer = nil): Tensor {.inline.} = self.dynamicCppCall("log_normal_", mean, std, generator).to(Tensor)
proc exponential_u*(self: Tensor, lambd: float64 = 1, generator: pointer = nil): Tensor {.inline.} = self.dynamicCppCall("exponential_", lambd, generator).to(Tensor)
proc geometric_u*(self: Tensor, p: float64, generator: pointer = nil): Tensor {.inline.} = self.dynamicCppCall("geometric_", p, generator).to(Tensor)
proc u_bernoulli_u*(self: Tensor, p: float64, generator: pointer = nil): Tensor {.inline.} = self.dynamicCppCall("_bernoulli_", p, generator).to(Tensor)
...
proc avg_pool1d*(self: Tensor, kernel_size: IntList, stride: IntList, padding: IntList = @[0], ceil_mode: bool = false, count_include_pad: bool = true): Tensor {.inline.} = dynamicCCall("at::avg_pool1d", self, kernel_size, stride, padding, ceil_mode, count_include_pad).to(Tensor)
proc adaptive_avg_pool1d*(self: Tensor, output_size: IntList): Tensor {.inline.} = dynamicCCall("at::adaptive_avg_pool1d", self, output_size).to(Tensor)
...
proc allclose*(self: Tensor, other: Tensor, rtol: float64, atol: float64, equal_nan: bool = false): bool {.inline.} = self.dynamicCppCall("allclose", other, rtol, atol, equal_nan).to(bool)
...
proc as_strided*(self: Tensor, size: IntList, stride: IntList): Tensor {.inline.} = self.dynamicCppCall("as_strided", size, stride).to(Tensor)
proc as_strided_u*(self: Tensor, size: IntList, stride: IntList): Tensor {.inline.} = self.dynamicCppCall("as_strided_", size, stride).to(Tensor)
proc as_strided*(self: Tensor, size: IntList, stride: IntList, storage_offset: int64): Tensor {.inline.} = self.dynamicCppCall("as_strided", size, stride, storage_offset).to(Tensor)
proc as_strided_u*(self: Tensor, size: IntList, stride: IntList, storage_offset: int64): Tensor {.inline.} = self.dynamicCppCall("as_strided_", size, stride, storage_offset).to(Tensor)
...
proc batch_norm*(input: Tensor, weight: Tensor, bias: Tensor, running_mean: Tensor, running_var: Tensor, training: bool, momentum: float64, eps: float64, cudnn_enabled: bool): Tensor {.inline.} = dynamicCCall("at::batch_norm", input, weight, bias, running_mean, running_var, training, momentum, eps, cudnn_enabled).to(Tensor)
...
proc convolution*(input: Tensor, weight: Tensor, bias: Tensor, stride: IntList, padding: IntList, dilation: IntList, transposed: bool, output_padding: IntList, groups: int64): Tensor {.inline.} = dynamicCCall("at::convolution", input, weight, bias, stride, padding, dilation, transposed, output_padding, groups).to(Tensor)
proc u_convolution*(input: Tensor, weight: Tensor, bias: Tensor, stride: IntList, padding: IntList, dilation: IntList, transposed: bool, output_padding: IntList, groups: int64, benchmark: bool, deterministic: bool, cudnn_enabled: bool): Tensor {.inline.} = dynamicCCall("at::_convolution", input, weight, bias, stride, padding, dilation, transposed, output_padding, groups, benchmark, deterministic, cudnn_enabled).to(Tensor)
proc u_convolution_nogroup*(input: Tensor, weight: Tensor, bias: Tensor, stride: IntList, padding: IntList, dilation: IntList, transposed: bool, output_padding: IntList): Tensor {.inline.} = dynamicCCall("at::_convolution_nogroup", input, weight, bias, stride, padding, dilation, transposed, output_padding).to(Tensor)
proc conv1d*(input: Tensor, weight: Tensor, bias: Tensor, stride: IntList = @[1], padding: IntList = @[0], dilation: IntList = @[1], groups: int64 = 1): Tensor {.inline.} = dynamicCCall("at::conv1d", input, weight, bias, stride, padding, dilation, groups).to(Tensor)
proc conv2d*(input: Tensor, weight: Tensor, bias: Tensor, stride: IntList = @[1], padding: IntList = @[0], dilation: IntList = @[1], groups: int64 = 1): Tensor {.inline.} = dynamicCCall("at::conv2d", input, weight, bias, stride, padding, dilation, groups).to(Tensor)
proc conv3d*(input: Tensor, weight: Tensor, bias: Tensor, stride: IntList = @[1], padding: IntList = @[0], dilation: IntList = @[1], groups: int64 = 1): Tensor {.inline.} = dynamicCCall("at::conv3d", input, weight, bias, stride, padding, dilation, groups).to(Tensor)
...
proc conv_transpose1d*(input: Tensor, weight: Tensor, bias: Tensor, stride: IntList = @[1], padding: IntList = @[0], output_padding: IntList = @[0], groups: int64 = 1, dilation: IntList = @[1]): Tensor {.inline.} = dynamicCCall("at::conv_transpose1d", input, weight, bias, stride, padding, output_padding, groups, dilation).to(Tensor)
proc conv_transpose2d*(input: Tensor, weight: Tensor, bias: Tensor, stride: IntList = @[1], padding: IntList = @[0], output_padding: IntList = @[0], groups: int64 = 1, dilation: IntList = @[1]): Tensor {.inline.} = dynamicCCall("at::conv_transpose2d", input, weight, bias, stride, padding, output_padding, groups, dilation).to(Tensor)
proc conv_transpose3d*(input: Tensor, weight: Tensor, bias: Tensor, stride: IntList = @[1], padding: IntList = @[0], output_padding: IntList = @[0], groups: int64 = 1, dilation: IntList = @[1]): Tensor {.inline.} = dynamicCCall("at::conv_transpose3d", input, weight, bias, stride, padding, output_padding, groups, dilation).to(Tensor)
...
proc cosine_embedding_loss*(input1: Tensor, input2: Tensor, target: Tensor, margin: float64, reduction: int64): Tensor {.inline.} = dynamicCCall("at::cosine_embedding_loss", input1, input2, target, margin, reduction).to(Tensor)
proc cudnn_convolution*(self: Tensor, weight: Tensor, bias: Tensor, padding: IntList, stride: IntList, dilation: IntList, groups: int64, benchmark: bool, deterministic: bool): Tensor {.inline.} = dynamicCCall("at::cudnn_convolution", self, weight, bias, padding, stride, dilation, groups, benchmark, deterministic).to(Tensor)
proc cudnn_convolution_backward_input*(self_size: IntList, grad_output: Tensor, weight: Tensor, padding: IntList, stride: IntList, dilation: IntList, groups: int64, benchmark: bool, deterministic: bool): Tensor {.inline.} = dynamicCCall("at::cudnn_convolution_backward_input", self_size, grad_output, weight, padding, stride, dilation, groups, benchmark, deterministic).to(Tensor)
...
proc cudnn_convolution_backward_weight*(weight_size: IntList, grad_output: Tensor, self: Tensor, padding: IntList, stride: IntList, dilation: IntList, groups: int64, benchmark: bool, deterministic: bool): Tensor {.inline.} = dynamicCCall("at::cudnn_convolution_backward_weight", weight_size, grad_output, self, padding, stride, dilation, groups, benchmark, deterministic).to(Tensor)
proc cudnn_convolution_transpose*(self: Tensor, weight: Tensor, bias: Tensor, padding: IntList, output_padding: IntList, stride: IntList, dilation: IntList, groups: int64, benchmark: bool, deterministic: bool): Tensor {.inline.} = dynamicCCall("at::cudnn_convolution_transpose", self, weight, bias, padding, output_padding, stride, dilation, groups, benchmark, deterministic).to(Tensor)
...
proc cudnn_convolution_transpose_backward_input*(grad_output: Tensor, weight: Tensor, padding: IntList, stride: IntList, dilation: IntList, groups: int64, benchmark: bool, deterministic: bool): Tensor {.inline.} = dynamicCCall("at::cudnn_convolution_transpose_backward_input", grad_output, weight, padding, stride, dilation, groups, benchmark, deterministic).to(Tensor)
proc cudnn_convolution_transpose_backward_weight*(weight_size: IntList, grad_output: Tensor, self: Tensor, padding: IntList, stride: IntList, dilation: IntList, groups: int64, benchmark: bool, deterministic: bool): Tensor {.inline.} = dynamicCCall("at::cudnn_convolution_transpose_backward_weight", weight_size, grad_output, self, padding, stride, dilation, groups, benchmark, deterministic).to(Tensor)
...
proc ctc_loss*(log_probs: Tensor, targets: Tensor, input_lengths: IntList, target_lengths: IntList, blank: int64 = 0, reduction: int64): Tensor {.inline.} = dynamicCCall("at::ctc_loss", log_probs, targets, input_lengths, target_lengths, blank, reduction).to(Tensor)
...
proc embedding_renorm_u*(self: Tensor, indices: Tensor, max_norm: float64, norm_type: float64): Tensor {.inline.} = dynamicCCall("at::embedding_renorm_", self, indices, max_norm, norm_type).to(Tensor)
...
proc empty_out*(aresult: Tensor, size: IntList): Tensor {.inline.} = dynamicCCall("at::empty_out", aresult, size).to(Tensor)
...
proc expand*(self: Tensor, size: IntList, implicit: bool = false): Tensor {.inline.} = self.dynamicCppCall("expand", size, implicit).to(Tensor)
...
proc hinge_embedding_loss*(self: Tensor, target: Tensor, margin: float64, reduction: int64): Tensor {.inline.} = dynamicCCall("at::hinge_embedding_loss", self, target, margin, reduction).to(Tensor)
...
proc group_norm*(input: Tensor, num_groups: int64, weight: Tensor, bias: Tensor, eps: float64, cudnn_enabled: bool = true): Tensor {.inline.} = dynamicCCall("at::group_norm", input, num_groups, weight, bias, eps, cudnn_enabled).to(Tensor)
...
proc irfft*(self: Tensor, signal_ndim: int64, normalized: bool = false, onesided: bool = true, signal_sizes: IntList): Tensor {.inline.} = self.dynamicCppCall("irfft", signal_ndim, normalized, onesided, signal_sizes).to(Tensor)
proc u_fft_with_size*(self: Tensor, signal_ndim: int64, complex_input: bool, complex_output: bool, inverse: bool, checked_signal_sizes: IntList, normalized: bool, onesided: bool, output_sizes: IntList): Tensor {.inline.} = self.dynamicCppCall("_fft_with_size", signal_ndim, complex_input, complex_output, inverse, checked_signal_sizes, normalized, onesided, output_sizes).to(Tensor)
...
proc isclose*(self: Tensor, other: Tensor, rtol: float64, atol: float64, equal_nan: bool = false): Tensor {.inline.} = self.dynamicCppCall("isclose", other, rtol, atol, equal_nan).to(Tensor)
...
proc layer_norm*(input: Tensor, normalized_shape: IntList, weight: Tensor, bias: Tensor, eps: float64, cudnn_enable: bool = true): Tensor {.inline.} = dynamicCCall("at::layer_norm", input, normalized_shape, weight, bias, eps, cudnn_enable).to(Tensor)
...
proc margin_ranking_loss*(input1: Tensor, input2: Tensor, target: Tensor, margin: float64, reduction: int64): Tensor {.inline.} = dynamicCCall("at::margin_ranking_loss", input1, input2, target, margin, reduction).to(Tensor)
...
proc max_pool1d*(self: Tensor, kernel_size: IntList, stride: IntList, padding: IntList = @[0], dilation: IntList = @[1], ceil_mode: bool = false): Tensor {.inline.} = dynamicCCall("at::max_pool1d", self, kernel_size, stride, padding, dilation, ceil_mode).to(Tensor)
proc max_pool2d*(self: Tensor, kernel_size: IntList, stride: IntList, padding: IntList = @[0], dilation: IntList = @[1], ceil_mode: bool = false): Tensor {.inline.} = dynamicCCall("at::max_pool2d", self, kernel_size, stride, padding, dilation, ceil_mode).to(Tensor)
proc max_pool3d*(self: Tensor, kernel_size: IntList, stride: IntList, padding: IntList = @[0], dilation: IntList = @[1], ceil_mode: bool = false): Tensor {.inline.} = dynamicCCall("at::max_pool3d", self, kernel_size, stride, padding, dilation, ceil_mode).to(Tensor)
...
proc mkldnn_convolution*(self: Tensor, weight: Tensor, bias: Tensor, padding: IntList, stride: IntList, dilation: IntList, groups: int64): Tensor {.inline.} = dynamicCCall("at::mkldnn_convolution", self, weight, bias, padding, stride, dilation, groups).to(Tensor)
proc mkldnn_convolution_backward_input*(self_size: IntList, grad_output: Tensor, weight: Tensor, padding: IntList, stride: IntList, dilation: IntList, groups: int64, bias_defined: bool): Tensor {.inline.} = dynamicCCall("at::mkldnn_convolution_backward_input", self_size, grad_output, weight, padding, stride, dilation, groups, bias_defined).to(Tensor)
...
proc ones_out*(aresult: Tensor, size: IntList): Tensor {.inline.} = dynamicCCall("at::ones_out", aresult, size).to(Tensor)
proc ones_like*(self: Tensor): Tensor {.inline.} = dynamicCCall("at::ones_like", self).to(Tensor)
proc pairwise_distance*(x1: Tensor, x2: Tensor, p: float64 = 2, eps: float64, keepdim: bool = false): Tensor {.inline.} = dynamicCCall("at::pairwise_distance", x1, x2, p, eps, keepdim).to(Tensor)
proc permute*(self: Tensor, dims: IntList): Tensor {.inline.} = self.dynamicCppCall("permute", dims).to(Tensor)
proc pin_memory*(self: Tensor): Tensor {.inline.} = self.dynamicCppCall("pin_memory").to(Tensor)
proc pinverse*(self: Tensor, rcond: float64): Tensor {.inline.} = self.dynamicCppCall("pinverse", rcond).to(Tensor)
proc rand_out*(aresult: Tensor, size: IntList): Tensor {.inline.} = dynamicCCall("at::rand_out", aresult, size).to(Tensor)
proc rand_like*(self: Tensor): Tensor {.inline.} = dynamicCCall("at::rand_like", self).to(Tensor)
proc randint_out*(aresult: Tensor, high: int64, size: IntList): Tensor {.inline.} = dynamicCCall("at::randint_out", aresult, high, size).to(Tensor)
proc randint_out*(aresult: Tensor, low: int64, high: int64, size: IntList): Tensor {.inline.} = dynamicCCall("at::randint_out", aresult, low, high, size).to(Tensor)
...
proc randn_out*(aresult: Tensor, size: IntList): Tensor {.inline.} = dynamicCCall("at::randn_out", aresult, size).to(Tensor)
...
proc repeat*(self: Tensor, repeats: IntList): Tensor {.inline.} = self.dynamicCppCall("repeat", repeats).to(Tensor)
proc reshape*(self: Tensor, shape: IntList): Tensor {.inline.} = self.dynamicCppCall("reshape", shape).to(Tensor)
proc reshape_as*(self: Tensor, other: Tensor): Tensor {.inline.} = self.dynamicCppCall("reshape_as", other).to(Tensor)
proc RoiPooling2d_backward*(input: Tensor, rois: Tensor, pooledHeight: int64, pooledWidth: int64, spatialScale: float64, gradOutput: Tensor, argmaxes: Tensor): Tensor {.inline.} = dynamicCCall("at::RoiPooling2d_backward", input, rois, pooledHeight, pooledWidth, spatialScale, gradOutput, argmaxes).to(Tensor)
...
proc split_with_sizes*(self: Tensor, split_sizes: IntList, dim: int64 = 0): TensorList {.inline.} = self.dynamicCppCall("split_with_sizes", split_sizes, dim).to(TensorList)
...
proc sum*(self: Tensor, dim: IntList, keepdim: bool = false): Tensor {.inline.} = self.dynamicCppCall("sum", dim, keepdim).to(Tensor)
proc u_sum*(self: Tensor, dim: IntList, keepdim: bool = false): Tensor {.inline.} = self.dynamicCppCall("_sum", dim, keepdim).to(Tensor)
proc sum_out*(aresult: Tensor, self: Tensor, dim: IntList, keepdim: bool = false): Tensor {.inline.} = dynamicCCall("at::sum_out", aresult, self, dim, keepdim).to(Tensor)
proc u_sum_out*(aresult: Tensor, self: Tensor, dim: IntList, keepdim: bool = false): Tensor {.inline.} = dynamicCCall("at::_sum_out", aresult, self, dim, keepdim).to(Tensor)
...
proc flip*(self: Tensor, dims: IntList): Tensor {.inline.} = self.dynamicCppCall("flip", dims).to(Tensor)
proc rot90*(self: Tensor, k: int64 = 1, dims: IntList): Tensor {.inline.} = self.dynamicCppCall("rot90", k, dims).to(Tensor)
proc u_trilinear*(i1: Tensor, i2: Tensor, i3: Tensor, expand1: IntList, expand2: IntList, expand3: IntList, sumdim: IntList, unroll_dim: int64 = 1): Tensor {.inline.} = dynamicCCall("at::_trilinear", i1, i2, i3, expand1, expand2, expand3, sumdim, unroll_dim).to(Tensor)
proc triplet_margin_loss*(anchor: Tensor, positive: Tensor, negative: Tensor, margin: float64, p: float64 = 2, eps: float64, swap: bool = false, reduction: int64): Tensor {.inline.} = dynamicCCall("at::triplet_margin_loss", anchor, positive, negative, margin, p, eps, swap, reduction).to(Tensor)
...
proc u_unsafe_view*(self: Tensor, size: IntList): Tensor {.inline.} = dynamicCCall("at::_unsafe_view", self, size).to(Tensor)
...
proc zeros_out*(aresult: Tensor, size: IntList): Tensor {.inline.} = dynamicCCall("at::zeros_out", aresult, size).to(Tensor)
...
proc u_sparse_coo_tensor_unsafe*(indices: Tensor, values: Tensor, size: IntList): Tensor {.inline.} = dynamicCCall("at::_sparse_coo_tensor_unsafe", indices, values, size).to(Tensor)
proc sparse_raw_resize_u*(self: Tensor, size: IntList, sparseDims: int64, denseDims: int64): Tensor {.inline.} = self.dynamicCppCall("sparse_raw_resize_", size, sparseDims, denseDims).to(Tensor)
