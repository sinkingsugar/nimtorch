...
#[ proc add_bwd*(grad: Tensor; fwd_result: Tensor): tuple[self: Tensor, other: Tensor] {.inline, noinit.} =
  ...
  result.self = self_result
  let other_result = maybe_multiply(grad, alpha)
...
#[ proc th_addmm_bwd*(grad: Tensor; fwd_result: Tensor): tuple[self: Tensor, mat1: Tensor, mat2: Tensor] {.inline, noinit.} =
  let self_result = maybe_multiply(grad, beta)
  result.self = self_result
  let mat1_result = mm_mat1_backward(grad, mat2, mat1.sizes(), mat1.strides(), alpha)
  result.mat1 = mat1_result
  let mat2_result = mm_mat2_backward(grad, mat1, mat2.sizes(), mat2.strides(), alpha)
...
#[ proc atan2_bwd*(grad: Tensor; fwd_result: Tensor, grad_input_mask: StdArray): tuple[self: Tensor, other: Tensor] {.inline, noinit.} =
  let self_result = atan2_backward(grad, self, other, grad_input_mask)
...
#[ proc bernoulli_bwd*(grad: Tensor; fwd_result: Tensor): tuple[self: Tensor] {.inline, noinit.} =
  let self_result = zeros_like(grad)
  result.self = self_result
 ]#
...
#[ proc conv_tbc_bwd*(grad: Tensor; fwd_result: Tensor): tuple[self: Tensor, weight: Tensor, bias: Tensor] {.inline, noinit.} =
  let self_result = conv_tbc_backward(grad, self, weight, bias, pad)
  result.self = self_result[0]
...
#[ proc eq_u_bwd*(grad: Tensor; fwd_result: Tensor): tuple[self: Tensor, other: Tensor] {.inline, noinit.} =
  let self_result = zeros_like(self)
  result.self = self_result
  let other_result = zeros_like(other)
  result.other = other_result
 ]#
...
#[ proc grid_sampler_2d_bwd*(grad: Tensor; fwd_result: Tensor): tuple[input: Tensor, grid: Tensor] {.inline, noinit.} =
  let input_result = grid_sampler_2d_backward(grad, input, grid, interpolation_mode, padding_mode)
...
#[ proc masked_fill_u_bwd*(grad: Tensor; fwd_result: Tensor): tuple[self: Tensor, value: Tensor] {.inline, noinit.} =
  let self_result = grad.clone().masked_fill_u(mask, 0)
  result.self = self_result
  let value_result = where(mask, grad, zeros_like(grad)).sum()
  result.value = value_result
 ]#
...
#[ proc masked_select_bwd*(grad: Tensor; fwd_result: Tensor): tuple[self: Tensor] {.inline, noinit.} =
  let self_result = zeros_like(self).masked_scatter_u(mask, grad)
  result.self = self_result
 ]#
...
#[ proc u_mm_bwd*(grad: Tensor; fwd_result: Tensor): tuple[self: Tensor, mat2: Tensor] {.inline, noinit.} =
  let self_result = mm_mat1_backward(grad, mat2, self.sizes(), self.strides(), 1)
  result.self = self_result
  let mat2_result = mm_mat2_backward(grad, self, mat2.sizes(), mat2.strides(), 1)
  result.mat2 = mat2_result
 ]#
...
#[ proc pow_bwd*(grad: Tensor; fwd_result: Tensor): tuple[self: Tensor] {.inline, noinit.} =
  let self_result = pow_backward(grad, self, exponent)
  result.self = self_result
 ]#
...
#[ proc pow_bwd*(grad: Tensor; fwd_result: Tensor): tuple[self: Tensor, exponent: Tensor] {.inline, noinit.} =
  let self_result = pow_backward_self(grad, self, exponent)
  result.self = self_result
  let exponent_result = pow_backward_exponent(grad, self, exponent)
...
#[ proc put_u_bwd*(grad: Tensor; fwd_result: Tensor): tuple[self: Tensor, source: Tensor] {.inline, noinit.} =
  let self_result = grad.clone().put_u(index, zeros_like(source), accumulate)
  result.self = self_result
...
#[ proc RoiPooling2d_forward_bwd*(grad: Tensor; fwd_result: tuple[result0: Tensor, result1: Tensor]): tuple[input: Tensor] {.inline, noinit.} =
  let input_result = RoiPooling2d_backward(input, rois, pooledHeight, pooledWidth, spatialScale, grad, fwd_result[1])
...
#[ proc sigmoid_bwd*(grad: Tensor; fwd_result: Tensor): tuple[self: Tensor] {.inline, noinit.} =
  let self_result = u_sigmoid_backward(grad, fwd_result)
  result.self = self_result
 ]#
...
#[ proc take_bwd*(grad: Tensor; fwd_result: Tensor): tuple[self: Tensor] {.inline, noinit.} =
  let self_result = zeros_like(self).put_u(index, grad, true)
  result.self = self_result
 ]#
...
#[ proc tanh_bwd*(grad: Tensor; fwd_result: Tensor): tuple[self: Tensor] {.inline, noinit.} =
  let self_result = u_tanh_backward(grad, fwd_result)
  result.self = self_result
 ]#
...
#[ proc u_s_where_bwd*(grad: Tensor; fwd_result: Tensor): tuple[self: Tensor, other: Tensor] {.inline, noinit.} =
  let self_result = where(condition, grad, zeros_like(grad))
  result.self = self_result
  let other_result = where(condition, zeros_like(grad), grad)
  result.other = other_result
 ]#
...
#[ proc binary_cross_entropy_bwd*(grad: Tensor; fwd_result: Tensor): tuple[self: Tensor] {.inline, noinit.} =
  let self_result = binary_cross_entropy_backward(grad, self, target, weight, reduction)
  result.self = self_result
 ]#
...
#[ proc embedding_bwd*(grad: Tensor; fwd_result: Tensor): tuple[weight: Tensor] {.inline, noinit.} =
  let weight_result = embedding_backward(grad, indices, weight.size(0), padding_idx, scale_grad_by_freq, sparse)
...
#[ proc u_embedding_bag_bwd*(grad: Tensor; fwd_result: tuple[result0: Tensor, result1: Tensor, result2: Tensor, result3: Tensor]): tuple[weight: Tensor] {.inline, noinit.} =
  let weight_result = u_embedding_bag_backward(grad, indices, offsets, fwd_result[1], fwd_result[2], fwd_result[3], weight.size(0), scale_grad_by_freq, mode, sparse)
  result.weight = weight_result
 ]#
...
#[ proc l1_loss_bwd*(grad: Tensor; fwd_result: Tensor): tuple[self: Tensor] {.inline, noinit.} =
  let self_result = l1_loss_backward(grad, self, target, reduction)
  result.self = self_result
 ]#
...
#[ proc mse_loss_bwd*(grad: Tensor; fwd_result: Tensor): tuple[self: Tensor] {.inline, noinit.} =
  let self_result = mse_loss_backward(grad, self, target, reduction)
  result.self = self_result
 ]#
...
#[ proc multi_margin_loss_bwd*(grad: Tensor; fwd_result: Tensor): tuple[self: Tensor] {.inline, noinit.} =
  let self_result = multi_margin_loss_backward(grad, self, target, p, margin, weight, reduction)
  result.self = self_result
 ]#
...
#[ proc multilabel_margin_loss_bwd*(grad: Tensor; fwd_result: tuple[output: Tensor, is_target: Tensor]): tuple[self: Tensor] {.inline, noinit.} =
  let self_result = multilabel_margin_loss_backward(grad, self, target, reduction, fwd_result.is_target)
  result.self = self_result
 ]#
...
#[ proc nll_loss_bwd*(grad: Tensor; fwd_result: tuple[output: Tensor, total_weight: Tensor]): tuple[self: Tensor] {.inline, noinit.} =
  let self_result = nll_loss_backward(grad, self, target, weight, reduction, ignore_index, fwd_result.total_weight)
  result.self = self_result
 ]#
...
#[ proc nll_loss2d_bwd*(grad: Tensor; fwd_result: tuple[output: Tensor, total_weight: Tensor]): tuple[self: Tensor] {.inline, noinit.} =
  let self_result = nll_loss2d_backward(grad, self, target, weight, reduction, ignore_index, fwd_result.total_weight)
  result.self = self_result
 ]#
...
#[ proc smooth_l1_loss_bwd*(grad: Tensor; fwd_result: Tensor): tuple[self: Tensor] {.inline, noinit.} =
  let self_result = smooth_l1_loss_backward(grad, self, target, reduction)
  result.self = self_result
 ]#
...
#[ proc soft_margin_loss_bwd*(grad: Tensor; fwd_result: Tensor): tuple[self: Tensor] {.inline, noinit.} =
  let self_result = soft_margin_loss_backward(grad, self, target, reduction)
  result.self = self_result
 ]#
...
#[ proc relu_bwd*(grad: Tensor; fwd_result: Tensor): tuple[self: Tensor] {.inline, noinit.} =
  let self_result = threshold_backward(grad, self, 0, 0)
  result.self = self_result
 ]#
...
#[ proc elu_bwd*(grad: Tensor; fwd_result: Tensor): tuple[self: Tensor] {.inline, noinit.} =
  let self_result = elu_backward(grad, alpha, scale, input_scale, fwd_result)
  result.self = self_result
 ]#
...
#[ proc glu_bwd*(grad: Tensor; fwd_result: Tensor): tuple[self: Tensor] {.inline, noinit.} =
  let self_result = glu_backward(grad, self, dim)
  result.self = self_result
 ]#
...
#[ proc hardtanh_bwd*(grad: Tensor; fwd_result: Tensor): tuple[self: Tensor] {.inline, noinit.} =
  let self_result = hardtanh_backward(grad, self, min_val, max_val)
  result.self = self_result
 ]#
...
#[ proc hardtanh_u_bwd*(grad: Tensor; fwd_result: Tensor): tuple[self: Tensor] {.inline, noinit.} =
  let self_result = hardtanh_backward(grad, fwd_result, min_val, max_val)
  result.self = self_result
 ]#
...
#[ proc leaky_relu_bwd*(grad: Tensor; fwd_result: Tensor): tuple[self: Tensor] {.inline, noinit.} =
  let self_result = leaky_relu_backward(grad, self, negative_slope)
  result.self = self_result
 ]#
...
#[ proc leaky_relu_u_bwd*(grad: Tensor; fwd_result: Tensor): tuple[self: Tensor] {.inline, noinit.} =
  let self_result = leaky_relu_backward(grad, fwd_result, negative_slope)
  result.self = self_result
 ]#
...
#[ proc log_sigmoid_bwd*(grad: Tensor; fwd_result: tuple[output: Tensor, buffer: Tensor]): tuple[self: Tensor] {.inline, noinit.} =
  let self_result = log_sigmoid_backward(grad, self, fwd_result.buffer)
  result.self = self_result
 ]#
...
#[ proc log_softmax_bwd*(grad: Tensor; fwd_result: Tensor): tuple[self: Tensor] {.inline, noinit.} =
  let self_result = log_softmax_backward_data(grad, fwd_result, dim, self)
  result.self = self_result
 ]#
...
#[ proc prelu_bwd*(grad: Tensor; fwd_result: Tensor, grad_input_mask: StdArray): tuple[self: Tensor, weight: Tensor] {.inline, noinit.} =
  let self_result = prelu_backward(grad, self, weight, grad_input_mask)
  result.self = self_result[0]
  result.weight = self_result[1]
 ]#
...
#[ proc rrelu_with_noise_u_bwd*(grad: Tensor; fwd_result: Tensor): tuple[self: Tensor] {.inline, noinit.} =
  let self_result = rrelu_with_noise_backward(grad, fwd_result, noise, lower, upper, training)
  result.self = self_result
 ]#
...
#[ proc softmax_bwd*(grad: Tensor; fwd_result: Tensor): tuple[self: Tensor] {.inline, noinit.} =
  let self_result = softmax_backward_data(grad, fwd_result, dim, self)
  result.self = self_result
 ]#
...
#[ proc softplus_bwd*(grad: Tensor; fwd_result: Tensor): tuple[self: Tensor] {.inline, noinit.} =
  let self_result = softplus_backward(grad, self, beta, threshold, fwd_result)
  result.self = self_result
 ]#
...
#[ proc softshrink_bwd*(grad: Tensor; fwd_result: Tensor): tuple[self: Tensor] {.inline, noinit.} =
  let self_result = softshrink_backward(grad, self, lambd)
  result.self = self_result
 ]#
...
#[ proc threshold_bwd*(grad: Tensor; fwd_result: Tensor): tuple[self: Tensor] {.inline, noinit.} =
  let self_result = threshold_backward(grad, self, threshold, value)
  result.self = self_result
 ]#
...
#[ proc threshold_u_bwd*(grad: Tensor; fwd_result: Tensor): tuple[self: Tensor] {.inline, noinit.} =
  let self_result = threshold_backward(grad, fwd_result, threshold, value)
  result.self = self_result
 ]#
...
#[ proc reflection_pad1d_bwd*(grad: Tensor; fwd_result: Tensor): tuple[self: Tensor] {.inline, noinit.} =
  let self_result = reflection_pad1d_backward(grad, self, padding)
  result.self = self_result
 ]#
...
#[ proc reflection_pad2d_bwd*(grad: Tensor; fwd_result: Tensor): tuple[self: Tensor] {.inline, noinit.} =
  let self_result = reflection_pad2d_backward(grad, self, padding)
  result.self = self_result
 ]#
...
#[ proc replication_pad1d_bwd*(grad: Tensor; fwd_result: Tensor): tuple[self: Tensor] {.inline, noinit.} =
  let self_result = replication_pad1d_backward(grad, self, padding)
  result.self = self_result
 ]#
...
#[ proc replication_pad2d_bwd*(grad: Tensor; fwd_result: Tensor): tuple[self: Tensor] {.inline, noinit.} =
  let self_result = replication_pad2d_backward(grad, self, padding)
  result.self = self_result
 ]#
...
#[ proc replication_pad3d_bwd*(grad: Tensor; fwd_result: Tensor): tuple[self: Tensor] {.inline, noinit.} =
  let self_result = replication_pad3d_backward(grad, self, padding)
  result.self = self_result
 ]#
...
#[ proc upsample_linear1d_bwd*(grad: Tensor; fwd_result: Tensor): tuple[self: Tensor] {.inline, noinit.} =
  let self_result = upsample_linear1d_backward(grad, output_size, self.sizes(), align_corners)
  result.self = self_result
 ]#
...
#[ proc upsample_bilinear2d_bwd*(grad: Tensor; fwd_result: Tensor): tuple[self: Tensor] {.inline, noinit.} =
  let self_result = upsample_bilinear2d_backward(grad, output_size, self.sizes(), align_corners)
  result.self = self_result
 ]#
...
#[ proc upsample_trilinear3d_bwd*(grad: Tensor; fwd_result: Tensor): tuple[self: Tensor] {.inline, noinit.} =
  let self_result = upsample_trilinear3d_backward(grad, output_size, self.sizes(), align_corners)
  result.self = self_result
 ]#
...
#[ proc upsample_nearest1d_bwd*(grad: Tensor; fwd_result: Tensor): tuple[self: Tensor] {.inline, noinit.} =
  let self_result = upsample_nearest1d_backward(grad, output_size, self.sizes())
  result.self = self_result
 ]#
...
#[ proc upsample_nearest2d_bwd*(grad: Tensor; fwd_result: Tensor): tuple[self: Tensor] {.inline, noinit.} =
  let self_result = upsample_nearest2d_backward(grad, output_size, self.sizes())
  result.self = self_result
 ]#
...
#[ proc upsample_nearest3d_bwd*(grad: Tensor; fwd_result: Tensor): tuple[self: Tensor] {.inline, noinit.} =
  let self_result = upsample_nearest3d_backward(grad, output_size, self.sizes())
  result.self = self_result
 ]#
...
#[ proc adaptive_avg_pool2d_bwd*(grad: Tensor; fwd_result: Tensor): tuple[self: Tensor] {.inline, noinit.} =
  let self_result = adaptive_avg_pool2d_backward(grad, self)
  result.self = self_result
 ]#
...
#[ proc adaptive_avg_pool3d_bwd*(grad: Tensor; fwd_result: Tensor): tuple[self: Tensor] {.inline, noinit.} =
  let self_result = adaptive_avg_pool3d_backward(grad, self)
  result.self = self_result
 ]#
...
#[ proc adaptive_max_pool2d_bwd*(grad: Tensor; fwd_result: tuple[output: Tensor, indices: Tensor]): tuple[self: Tensor] {.inline, noinit.} =
  let self_result = adaptive_max_pool2d_backward(grad, self, fwd_result.indices)
  result.self = self_result
 ]#
...
#[ proc adaptive_max_pool3d_bwd*(grad: Tensor; fwd_result: tuple[output: Tensor, indices: Tensor]): tuple[self: Tensor] {.inline, noinit.} =
  let self_result = adaptive_max_pool3d_backward(grad, self, fwd_result.indices)
  result.self = self_result
 ]#
...
#[ proc avg_pool2d_bwd*(grad: Tensor; fwd_result: Tensor): tuple[self: Tensor] {.inline, noinit.} =
  let self_result = avg_pool2d_backward(grad, self, kernel_size, stride, padding, ceil_mode, count_include_pad)
  result.self = self_result
 ]#
...
#[ proc avg_pool3d_bwd*(grad: Tensor; fwd_result: Tensor): tuple[self: Tensor] {.inline, noinit.} =
  let self_result = avg_pool3d_backward(grad, self, kernel_size, stride, padding, ceil_mode, count_include_pad)
  result.self = self_result
 ]#
...
#[ proc fractional_max_pool2d_bwd*(grad: Tensor; fwd_result: tuple[output: Tensor, indices: Tensor]): tuple[self: Tensor] {.inline, noinit.} =
  let self_result = fractional_max_pool2d_backward(grad, self, kernel_size, output_size, fwd_result.indices)
  result.self = self_result
 ]#
...
#[ proc max_pool2d_with_indices_bwd*(grad: Tensor; fwd_result: tuple[output: Tensor, indices: Tensor]): tuple[self: Tensor] {.inline, noinit.} =
  let self_result = max_pool2d_with_indices_backward(grad, self, kernel_size, stride, padding, dilation, ceil_mode, fwd_result.indices)
  result.self = self_result
 ]#
...
#[ proc max_pool3d_with_indices_bwd*(grad: Tensor; fwd_result: tuple[output: Tensor, indices: Tensor]): tuple[self: Tensor] {.inline, noinit.} =
  let self_result = max_pool3d_with_indices_backward(grad, self, kernel_size, stride, padding, dilation, ceil_mode, fwd_result.indices)
  result.self = self_result
 ]#
...
#[ proc max_unpool2d_bwd*(grad: Tensor; fwd_result: Tensor): tuple[self: Tensor] {.inline, noinit.} =
  let self_result = max_unpool2d_backward(grad, self, indices, output_size)
  result.self = self_result
 ]#
...
#[ proc max_unpool3d_bwd*(grad: Tensor; fwd_result: Tensor): tuple[self: Tensor] {.inline, noinit.} =
  let self_result = max_unpool3d_backward(grad, self, indices, output_size, stride, padding)
  result.self = self_result
 ]#
...
#[ proc thnn_batch_norm_bwd*(grad: Tensor; fwd_result: tuple[output: Tensor, save_mean: Tensor, save_std: Tensor], grad_input_mask: StdArray): tuple[self: Tensor, weight: Tensor, bias: Tensor] {.inline, noinit.} =
  let self_result = thnn_batch_norm_backward(grad.contiguous(), self, weight, running_mean, running_var, training, eps, fwd_result.save_mean, fwd_result.save_std, grad_input_mask)
  result.self = self_result[0]
  result.weight = self_result[1]
  result.bias = self_result[2]
 ]#
...
#[ proc thnn_conv3d_bwd*(grad: Tensor; fwd_result: tuple[output: Tensor, finput: Tensor, fgrad_input: Tensor], grad_input_mask: StdArray): tuple[self: Tensor, weight: Tensor, bias: Tensor] {.inline, noinit.} =
  let self_result = thnn_conv3d_backward(grad, self, weight, kernel_size, stride, padding, fwd_result.finput, fwd_result.fgrad_input, grad_input_mask)
  result.self = self_result[0]
  result.weight = self_result[1]
  result.bias = self_result[2]
 ]#
...
#[ proc adaptive_avg_pool3d_backward_bwd*(grad: Tensor; fwd_result: Tensor): tuple[grad_output: Tensor, self: Tensor] {.inline, noinit.} =
  let grad_output_result = adaptive_avg_pool3d(grad, @[ grad_output.size(-3), grad_output.size(-2), grad_output.size(-1) ])
  result.grad_output = grad_output_result
  let self_result = zeros_like(self)
  result.self = self_result
 ]#
...
#[ proc avg_pool2d_backward_bwd*(grad: Tensor; fwd_result: Tensor): tuple[grad_output: Tensor, self: Tensor] {.inline, noinit.} =
  let grad_output_result = avg_pool2d(grad, kernel_size, stride, padding, ceil_mode, count_include_pad)
  result.grad_output = grad_output_result
  let self_result = zeros_like(self)
  result.self = self_result
 ]#
...
#[ proc avg_pool3d_backward_bwd*(grad: Tensor; fwd_result: Tensor): tuple[grad_output: Tensor, self: Tensor] {.inline, noinit.} =
  let grad_output_result = avg_pool3d(grad, kernel_size, stride, padding, ceil_mode, count_include_pad)
  result.grad_output = grad_output_result
  let self_result = zeros_like(self)
  result.self = self_result
 ]#
...
#[ proc hardtanh_backward_bwd*(grad: Tensor; fwd_result: Tensor): tuple[grad_output: Tensor, self: Tensor] {.inline, noinit.} =
  let grad_output_result = hardtanh_backward(grad, self, min_val, max_val)
  result.grad_output = grad_output_result
  let self_result = zeros_like(grad)
  result.self = self_result
 ]#
...
#[ proc leaky_relu_backward_bwd*(grad: Tensor; fwd_result: Tensor): tuple[grad_output: Tensor, self: Tensor] {.inline, noinit.} =
  let grad_output_result = leaky_relu_backward(grad, self, negative_slope)
  result.grad_output = grad_output_result
  let self_result = zeros_like(grad)
  result.self = self_result
 ]#
...
#[ proc max_unpool2d_backward_bwd*(grad: Tensor; fwd_result: Tensor): tuple[grad_output: Tensor, self: Tensor] {.inline, noinit.} =
  let grad_output_result = max_unpool2d(grad, indices, output_size)
  result.grad_output = grad_output_result
  let self_result = zeros_like(self)
  result.self = self_result
 ]#
...
#[ proc nll_loss_backward_bwd*(grad: Tensor; fwd_result: Tensor): tuple[grad_output: Tensor, self: Tensor] {.inline, noinit.} =
  let grad_output_result = nll_loss(grad, target, weight, reduction, ignore_index)
  result.grad_output = grad_output_result
  let self_result = zeros_like(grad)
  result.self = self_result
 ]#
...
#[ proc nll_loss2d_backward_bwd*(grad: Tensor; fwd_result: Tensor): tuple[grad_output: Tensor, self: Tensor] {.inline, noinit.} =
  let grad_output_result = nll_loss2d(grad, target, weight, reduction, ignore_index)
  result.grad_output = grad_output_result
  let self_result = zeros_like(grad)
  result.self = self_result
 ]#
...
#[ proc rrelu_with_noise_backward_bwd*(grad: Tensor; fwd_result: Tensor): tuple[grad_output: Tensor, self: Tensor] {.inline, noinit.} =
  let grad_output_result = rrelu_with_noise_backward(grad, self, noise, lower, upper, training)
  result.grad_output = grad_output_result
  let self_result = zeros_like(grad)
  result.self = self_result
 ]#
...
#[ proc reflection_pad1d_backward_bwd*(grad: Tensor; fwd_result: Tensor): tuple[grad_output: Tensor, self: Tensor] {.inline, noinit.} =
  let grad_output_result = reflection_pad1d(grad, padding)
  result.grad_output = grad_output_result
  let self_result = zeros_like(self)
  result.self = self_result
 ]#
...
#[ proc reflection_pad2d_backward_bwd*(grad: Tensor; fwd_result: Tensor): tuple[grad_output: Tensor, self: Tensor] {.inline, noinit.} =
  let grad_output_result = reflection_pad2d(grad, padding)
  result.grad_output = grad_output_result
  let self_result = zeros_like(self)
  result.self = self_result
 ]#
...
#[ proc replication_pad1d_backward_bwd*(grad: Tensor; fwd_result: Tensor): tuple[grad_output: Tensor, self: Tensor] {.inline, noinit.} =
  let grad_output_result = replication_pad1d(grad, padding)
  result.grad_output = grad_output_result
  let self_result = zeros_like(self)
  result.self = self_result
 ]#
...
#[ proc replication_pad2d_backward_bwd*(grad: Tensor; fwd_result: Tensor): tuple[grad_output: Tensor, self: Tensor] {.inline, noinit.} =
  let grad_output_result = replication_pad2d(grad, padding)
  result.grad_output = grad_output_result
  let self_result = zeros_like(self)
  result.self = self_result
 ]#
...
#[ proc replication_pad3d_backward_bwd*(grad: Tensor; fwd_result: Tensor): tuple[grad_output: Tensor, self: Tensor] {.inline, noinit.} =
  let grad_output_result = replication_pad3d(grad, padding)
  result.grad_output = grad_output_result
  let self_result = zeros_like(self)
  result.self = self_result
 ]#
...
#[ proc softshrink_backward_bwd*(grad: Tensor; fwd_result: Tensor): tuple[grad_output: Tensor, self: Tensor] {.inline, noinit.} =
  let grad_output_result = softshrink_backward(grad, self, lambd)
  result.grad_output = grad_output_result
  let self_result = zeros_like(grad)
  result.self = self_result
 ]#
...
#[ proc threshold_backward_bwd*(grad: Tensor; fwd_result: Tensor): tuple[grad_output: Tensor, self: Tensor] {.inline, noinit.} =
  let grad_output_result = threshold_backward(grad, self, threshold, value)
  result.grad_output = grad_output_result
  let self_result = zeros_like(grad)
  result.self = self_result
 ]#
...
#[ proc upsample_linear1d_backward_bwd*(grad: Tensor; fwd_result: Tensor): tuple[grad_output: Tensor] {.inline, noinit.} =
  let grad_output_result = upsample_linear1d(grad, output_size, align_corners)
  result.grad_output = grad_output_result
 ]#
...
#[ proc upsample_bilinear2d_backward_bwd*(grad: Tensor; fwd_result: Tensor): tuple[grad_output: Tensor] {.inline, noinit.} =
  let grad_output_result = upsample_bilinear2d(grad, output_size, align_corners)
  result.grad_output = grad_output_result
 ]#
...
#[ proc upsample_trilinear3d_backward_bwd*(grad: Tensor; fwd_result: Tensor): tuple[grad_output: Tensor] {.inline, noinit.} =
  let grad_output_result = upsample_trilinear3d(grad, output_size, align_corners)
  result.grad_output = grad_output_result
 ]#
...
#[ proc upsample_nearest1d_backward_bwd*(grad: Tensor; fwd_result: Tensor): tuple[grad_output: Tensor] {.inline, noinit.} =
  let grad_output_result = upsample_nearest1d(grad, output_size)
  result.grad_output = grad_output_result
 ]#
...
#[ proc upsample_nearest2d_backward_bwd*(grad: Tensor; fwd_result: Tensor): tuple[grad_output: Tensor] {.inline, noinit.} =
  let grad_output_result = upsample_nearest2d(grad, output_size)
  result.grad_output = grad_output_result
 ]#
...
#[ proc upsample_nearest3d_backward_bwd*(grad: Tensor; fwd_result: Tensor): tuple[grad_output: Tensor] {.inline, noinit.} =
  let grad_output_result = upsample_nearest3d(grad, output_size)
  result.grad_output = grad_output_result
 ]#
...
#[ proc u_sigmoid_backward_bwd*(grad: Tensor; fwd_result: Tensor): tuple[grad_output: Tensor, output: Tensor] {.inline, noinit.} =
  let grad_output_result = u_sigmoid_backward(grad, fwd_result)
  result.grad_output = grad_output_result
...
#[ proc u_tanh_backward_bwd*(grad: Tensor; fwd_result: Tensor): tuple[grad_output: Tensor, output: Tensor] {.inline, noinit.} =
  let grad_output_result = u_tanh_backward(grad, fwd_result)
  result.grad_output = grad_output_result
...
#[ proc cudnn_convolution_transpose_bwd*(grad: Tensor; fwd_result: Tensor, grad_input_mask: StdArray): tuple[self: Tensor, weight: Tensor, bias: Tensor] {.inline, noinit.} =
  let self_result = cudnn_convolution_transpose_backward(self, grad, weight, padding, output_padding, stride, dilation, groups, benchmark, deterministic, grad_input_mask)
  result.self = self_result[0]
  result.weight = self_result[1]
  result.bias = self_result[2]
 ]#
...
#[ proc cudnn_batch_norm_bwd*(grad: Tensor; fwd_result: tuple[result0: Tensor, result1: Tensor, result2: Tensor], grad_input_mask: StdArray): tuple[input: Tensor, weight: Tensor, bias: Tensor] {.inline, noinit.} =
  ...
  let input_result =  cudnn_batch_norm_backward(input, grad.contiguous(), weight, running_mean, running_var, fwd_result[1], fwd_result[2], epsilon) : thnn_batch_norm_backward(grad.contiguous(), input, weight, running_mean, running_var, training, epsilon, fwd_result[1], fwd_result[2], grad_input_mask)
  result.input = input_result[0]
...
#[ proc u_thnn_fused_gru_cell_bwd*(grad: Tensor; fwd_result: tuple[result0: Tensor, result1: Tensor]): tuple[input_gates: Tensor, hidden_gates: Tensor, hx: Tensor, input_bias: Tensor, hidden_bias: Tensor] {.inline, noinit.} =
  let input_gates_result = u_thnn_fused_gru_cell_backward(grad, fwd_result[1], input_bias.defined())
